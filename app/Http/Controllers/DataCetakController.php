...
class DataCetakController extends Controller
{
    ...
    public function cetak_persetujuan_kredit(Request $request)
    {
        try {
            ...
            // Jika produk KTA, kecualikan role_name "Kepala Kantor Kas" dan "Customer Service"
            if ($cek->produk_kode === 'KTA') {
                $usulanQuery->whereNotIn('v_users.role_name', ['Kepala Kantor Kas', 'Customer Service']);
            }
