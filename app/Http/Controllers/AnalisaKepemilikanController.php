    ...
    public function store(Request $request)
    {
        try {
            ...
            $data = [
                ...
                'nama_lain1' => strtoupper($request->nama_lain1) ?? null,
                'nama_lain2' => strtoupper($request->nama_lain2) ?? null,
                'nama_lain3' => strtoupper($request->nama_lain3) ?? null,
                'nama_lain4' => strtoupper($request->nama_lain4) ?? null,
            ];
            // dd($data);
            if ($data) {
