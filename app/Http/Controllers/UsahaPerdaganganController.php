...
class UsahaPerdaganganController extends Controller
{
    ...
    public function simpanbarang(Request $request)
    {
        ...
        $request->validate([
            ...
            'jual2' => 'required',
            'stock2' => 'required',
            'nama_barang3' => 'required',
            'hrg3' => 'required',
            'jual3' => 'required',
            'stock3' => 'required',
            'nama_barang4' => 'required',
            'hrg4' => 'required',
            'jual4' => 'required',
            'stock4' => 'required',
            'nama_barang5' => 'required',
            'hrg5' => 'required',
            'jual5' => 'required',
            'stock5' => 'required',
            'nama_barang6' => 'required',
            'hrg6' => 'required',
            'jual6' => 'required',
            'stock6' => 'required',
            'nama_barang7' => 'required',
            'hrg7' => 'required',
            'jual7' => 'required',
            'stock7' => 'required',
            'nama_barang8' => 'required',
            'hrg8' => 'required',
            'jual8' => 'required',
            'stock8' => 'required',
            'nama_barang9' => 'required',
            'hrg9' => 'required',
            'jual9' => 'required',
            'stock9' => 'required',
            'nama_barang10' => 'required',
            'hrg10' => 'required',
            'jual10' => 'required',
            'stock10' => 'required',
        ]);
