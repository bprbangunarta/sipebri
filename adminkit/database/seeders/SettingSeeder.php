...
class SettingSeeder extends Seeder
{
    private const SETTINGS = [
        ...
        'permission_entity_order' => '["permissions","roles","users","appearance","menus","storage","activity","dashboard","profile","offices","institutions","products","installments","methods","committees","collateral-types","collateral-bindings","collateral-conditions","collateral-methods"]',
        'search_indexable' => '0',
