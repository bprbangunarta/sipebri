...
class CollateralSimulationSeeder extends Seeder
{
    private const SAMPLES = [
        [
            ...
            'guarantee_value' => 17295845,
            'fair_value' => 17295845,
            'appraisal_value' => 17295845,
            'appraised_at' => '2024-09-26',
            'condition_code' => '9',
            'insurance_code' => 'T',
            'ppap_code' => '1',
            'insurance_date' => '2024-09-27',
        ],
        [
            ...
            'region_code' => '0121',
            'region_label' => '0121 : Kab. Subang',
            'guarantee_value' => 300000000,
            'fair_value' => 300000000,
            'njop_value' => 300000000,
            'appraisal_value' => 73740000,
            'appraised_at' => '2026-05-12',
            'appraiser_name' => 'NAUFAL',
            'condition_code' => '9',
            'insurance_code' => 'T',
            'ppap_code' => '1',
            'insurance_date' => '2026-05-12',
        ],
    ];
