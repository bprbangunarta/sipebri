...
- Jun 2026 (20/08): Referensi baru **Jenis Agunan** (19 data, `/collateral-types`) dan **Jenis Pengikatan** (7 data, `/binding-types`) memakai pola `ReferenceController` + `pages/Reference.vue`; izin `collateral-types.*` & `binding-types.*` ditambahkan ke `Modules::MAP` (total 32 izin), MenuSeeder & SettingSeeder diperbarui.
