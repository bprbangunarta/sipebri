...
- Jun 2026 (20/08): **Aturan format angka Indonesia** ditetapkan & diterapkan: komponen baru `resources/js/components/ui/NumberInput.vue` (tampil `1.000`, nilai simpan `1000`) dipakai di ProductDetail (plafon & tenor), CommitteeDetail (plafon jenjang), CommitteeSimulator (plafon), dan seluruh field nilai pada form Contoh Agunan. Aturan wajib dicatat di `/app/memory/ui_rules.md` + README.
