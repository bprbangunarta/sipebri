        ...
        <div class="data">
            ...
            <ol style="margin-left: -16px; margin-top: -13px; line-height: 1.5em;">
                <li style="text-align: justify;">
                    ...
                    <b>{{ $data->suku_bunga }}%
                        {{ $data->metode_rps }}</b> per tahun dengan jangka waktu kredit selama
                    {{ $data->jangka_waktu }}
                    bulan sesuai dengan surat perjanjian kredit restrukturisasi nomor <b>{{ $data->no_spk }}</b>, yang
                    telah ditandatangani bersama pada tanggal <b>{{ $data->tgl_rsc }}</b>.
                </li>
                <li style="text-align: justify;">
                ...
                <li style="text-align: justify;">
                    Sehubungan dengan kredit saya saat ini tidak tercover oleh asuransi jiwa dan apabila dikemudian
                    hari terjadi sesuatu hal yang mengakibatkan saya meninggal dunia, maka seluruh kewajiban saya kepada
                    PT. BPR BANGUNARTA yang tidak dapat ditanggung oleh pihak asuransi jiwa menjadi tanggung jawab ahli
                    waris sepenuhnya.
                </li>
            </ol>
            <p style="text-align: justify;">Demikian surat pernyataan ini saya buat dengan sebenarnya dalam keadaan
                sehat jasmani dan rohani tidak ada paksaan dari pihak manapun</p>
