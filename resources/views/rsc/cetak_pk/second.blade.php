                        ...
                        <table>
                            <tr>
                                ...
                                <td colspan="3" style="text-align: justify;">
                                    ...
                                    dalam Surat Perjanjian Kredit nomor <font class="text-hg">{{ $data->no_spk }}</font>
                                    tanggal <font class="text-hg">{{ $data->tgl_create_pk }}</font> yang
                        ...
                        <table style="margin-left: 12px; width: 97%;">
                            ...
                            <tr>
                                ...
                                <td style="text-align: justify;">Jangka waktu kredit menjadi {{ $data->jw_rsc }} (
                                    ...
                                    pertahun yang harus dibayar setiap bulannya secara {{ $data->metode_rps_rsc }};
                                </td>
                                <td></td>
                            </tr>
                            <tr>
                                ...
                                <td style="text-align: justify;">Kesanggupan bayar pokok sebesar Rp.
                                    ...
                                    ) dan bunga sebesar Rp. {{ number_format($data->angsuran_bunga, '0', ',', '.') }} (
                                    <font style="text-transform: capitalize;">
                                        {{ Riskihajar\Terbilang\Facades\Terbilang::make($data->angsuran_bunga) }}
                                    </font> Rupiah
                                    ) tiap bulan yang dimulai tanggal {{ $data->tgl_mulai_rsc }};
                                </td>
                                <td></td>
                            </tr>
                            <tr>
