@extends('theme.app')
@section('title', 'Cetak Perjanjian Kredit RSC')
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            ...
                            <h3 class="box-title">CETAK PERJANJIAN KREDIT RSC</h3>
                                    ...
                                    @forelse ($data as $item)
                                        <tr>
                                            ...
                                            <td class="text-center" style="text-align: center;">
                                                <a href="{{ route('rsc.cetakpk.detail', ['rsc' => $item->rsc, 'status_rsc' => $item->status_rsc]) }}"
