                    ...
                    <div class="content">
                                ...
                                <td colspan="3" style="text-align: justify;">
                                    ...
                                    dalam Surat Perjanjian Kredit nomor <font class="text-hg">
                                        ...
                                        @else
                                            {{ $data->no_spk }}
                                        @endif
                                    </font> tanggal <font class="text-hg">
                                        @if (!empty($data->pk_rsc_before))
                        ...
                        <table style="margin-left: 12px; width: 97%;">
                            ...
                            <tr>
                                ...
                                <td style="text-align: justify;">Kesanggupan bayar pokok dimulai pada tanggal
                                    {{ $data->tgl_bayar_rsc }} selama
                                    {{ $data->jw_rsc }} (
                                    <font style="text-transform: capitalize;">
                                        {{ Riskihajar\Terbilang\Facades\Terbilang::make($data->jw_rsc) }}
                                    </font>
                            ...
                            <tr>
                                <td>d. </td>
                                <td>
                                    Pembayaran bunga setiap bulan dimuali tanggal {{ $data->tgl_bayar_rsc }} selama
                                    {{ $data->jw_rsc }} (
                                    <font style="text-transform: capitalize;">
                                        {{ Riskihajar\Terbilang\Facades\Terbilang::make($data->jw_rsc) }}
                                    </font>
                        ...
                        @else
                            ...
                            <table>
                                ...
                                <tr>
                                    <td></td>
                                    <td>
                                        - &nbsp;&nbsp;Pembayaran Angsuran Pokok setiap {{ $data->jp_rsc }} bulan
                                        dimulai
                                        pada tanggal {{ $data->tgl_mulai_rsc }} selama {{ $data->jw_rsc }} (
                                        <font style="text-transform: capitalize;">
                                            {{ Riskihajar\Terbilang\Facades\Terbilang::make($data->jw_rsc) }}
                                        </font>
                                        ) bulan.
                                ...
                                <tr>
                                    <td></td>
                                    <td>
                                        - &nbsp;&nbsp;Pembayaran Angsuran Bunga setiap {{ $data->jb_rsc }} bulan
                                        dimulai
                                        pada tanggal {{ $data->tgl_mulai_rsc }} selama {{ $data->jw_rsc }} (
                                        <font style="text-transform: capitalize;">
                                            {{ Riskihajar\Terbilang\Facades\Terbilang::make($data->jw_rsc) }}
                            ...
                            <p>Dengan disepakatinya Perubahan Perjanjian Kredit ini, semua syarat-syarat dan
                                ...
                                @else
                                    ...
                                    lainnya yang bersangkutan dengan pemberian kredit tersebut dengan ini dinyatakan
                                    tetap
