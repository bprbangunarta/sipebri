                            ...
                            <tr>
                                ...
                                <td colspan="3" style="text-align: justify;">
                                    ...
                                    @if (!empty($data->pk_rsc_before))
                                        <font class="text-hg">Rp.
                                            {{ number_format($data->plafon_rsc_before, '0', ',', '.') }}
                                            ( <font style="text-transform: capitalize;">
                                                {{ Riskihajar\Terbilang\Facades\Terbilang::make($data->plafon_rsc_before) }}
                                            </font>
                                            Rupiah
                                            )</font>
                                    @else
                                    ...
                                    @endif
                                    dengan syarat-syarat/ketentuan-ketentuan dan sebagaimana tercantum
                        ...
                        <table style="margin-left: 12px; width: 97%;">
                            ...
                            <tr>
                                ...
                                <td style="text-align: justify;">Kesanggupan bayar pokok sebesar Rp.
                                    ...
                                    </font> Rupiah) dimulai pada tanggal {{ $data->tgl_mulai_rsc }} selama
                                    {{ $data->jw_rsc }} (
                                    <font style="text-transform: capitalize;">
                                        {{ Riskihajar\Terbilang\Facades\Terbilang::make($data->jw_rsc) }}
                                    </font>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    ) setiap bulan dimuali tanggal {{ $data->tgl_mulai_rsc }} selama
                                    {{ $data->jw_rsc }} (
                                    <font style="text-transform: capitalize;">
                                        {{ Riskihajar\Terbilang\Facades\Terbilang::make($data->jw_rsc) }}
                                    </font>
