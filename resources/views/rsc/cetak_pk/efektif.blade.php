                        ...
                        <table style="margin-left: 12px; width: 97%;">
                            ...
                            <tr>
                                ...
                                <td style="text-align: justify;">Jangka waktu kredit menjadi {{ $data->jw_rsc }} (
                                    ...
                                    pertahun yang harus dibayar setiap bulannya;
                                </td>
                                <td></td>
                            </tr>
                            <tr>
                                ...
                                <td style="text-align: justify;">Kesanggupan bayar pokok sebesar Rp.
                                    ...
                                    </font> Rupiah) pada saat tanggal jatuh tempo dan bunga setiap
                                    {{ $data->jb_rsc }} (
                                    <font style="text-transform: capitalize;">
                                        {{ Riskihajar\Terbilang\Facades\Terbilang::make($data->jb_rsc) }}
                                    </font>
                                    ) bulan selama {{ $data->jw_rsc }} (
                                    <font style="text-transform: capitalize;">
                                        {{ Riskihajar\Terbilang\Facades\Terbilang::make($data->jw_rsc) }}
                                    </font>
                                    ) bulan;
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        {{ number_format($data->angsuran_pokok, '0', ',', '.') }} ( <font
                                            style="text-transform: capitalize;">
                                            {{ Riskihajar\Terbilang\Facades\Terbilang::make($data->angsuran_pokok) }}
                                        </font> Rupiah ) pada saat tanggal jatuh tempo.
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>
                                        - &nbsp;&nbsp;Angsuran Bunga setiap {{ $data->jp_rsc }} bulan selama
                                        @if (is_null($data->jw_rsc_musiman))
                                            {{ $data->jw_rsc }} bulan.
                                        @else
                                            {{ $data->jw_rsc }} musim.
                                        @endif
