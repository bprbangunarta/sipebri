                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            ...
                            <h3 class="box-title">DATA {{ $status }} RSC</h3>

                            <div class="box-tools">
                                <form action="{{ route('monitoring.rsc.detail') }}" method="GET">
                                    <div class="input-group input-group-sm hidden-xs" style="width: 305px;">
                                        <input type="text" class="form-control text-uppercase pull-right"
                                            style="width: 180px;font-size:11.4px;" name="keyword" id="keyword"
                                            value="{{ request('keyword') }}" placeholder="Kode RSC">
                                ...
                                <tbody>
                                    @forelse ($data as $item)
                                        <tr class="text-uppercase">
                                            ...
                                            <td class="text-center">{{ $item->suku_bunga ?: 0 }}%</td>
