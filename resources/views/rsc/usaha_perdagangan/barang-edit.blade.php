                        ...
                        <div style="overflow: auto; width: 100%; height: 355px;">
                            <table class="table table-hover" style="font-size: 12px;">
                                ...
                                <tbody>
                                    <tr>
                                        <td>
                                            <input type="text" value="{{ $barang[0]->id }}" name="kode_barang1" hidden>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" value="{{ $barang[1]->id }}" name="kode_barang2" hidden>
                                            <input class="form-control input-sm form-border" type="text"
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" value="{{ $barang[2]->id }}" name="kode_barang3"
                                                hidden>
                                            <input class="form-control input-sm form-border" type="text"
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" value="{{ $barang[3]->id }}" name="kode_barang4"
                                                hidden>
                                            <input class="form-control input-sm form-border" type="text"
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" value="{{ $barang[4]->id }}" name="kode_barang5"
                                                hidden>
                                            <input class="form-control input-sm form-border" type="text"
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" value="{{ $barang[5]->id }}" name="kode_barang6"
                                                hidden>
                                            <input class="form-control input-sm form-border" type="text"
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" value="{{ $barang[6]->id }}" name="kode_barang7"
                                                hidden>
                                            <input class="form-control input-sm form-border" type="text"
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" value="{{ $barang[7]->id }}" name="kode_barang8"
                                                hidden>
                                            <input class="form-control input-sm form-border" type="text"
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" value="{{ $barang[8]->id }}" name="kode_barang9"
                                                hidden>
                                            <input class="form-control input-sm form-border" type="text"
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" value="{{ $barang[9]->id }}" name="kode_barang10"
                                                hidden>
                                            <input class="form-control input-sm form-border" type="text"
