...
@section('content')
    <div class="tab-content">
        <div class="tab-pane active">
            ...
            <form action="{{ route('rsc.usaha.lain.keuangan.update', ['kode_usaha' => $data->kode_usaha]) }}"
                id="keuangan_lainnya" method="post">
                @method('put')
                @csrf
                    ...
                    <div class="div-left">
                        @foreach ($pendapatan as $item)
                            <div style="width: 49.5%; float: left;">
                                ...
                                <input type="text" name="kode{{ $loop->iteration }}" value="{{ $item->id }}" hidden>
                        ...
                        @foreach ($biaya as $item)
                            <div style="width: 49.5%;float:left;">
                                ...
                                <input type="text" name="kod{{ $loop->iteration }}" value="{{ $item->id }}" hidden>
                                <input class="form-control input-sm form-border" type="text" placeholder="ENTRI"
