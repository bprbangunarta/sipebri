...
@section('title', 'Analisa Usaha Pertanian RSC')
                    ...
                    @forelse ($pertanian as $item)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('rsc.usaha.pertanian.informasi', ['kode_usaha' => $item->kd_usaha, 'kode' => $data->kode, 'rsc' => $data->rsc, 'status_rsc' => $data->status_rsc]) }}"
