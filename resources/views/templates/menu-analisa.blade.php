<div class="col-3 d-none d-md-block border-end">
    <div class="card-body">
        <div class="list-group list-group-transparent">
            <a href="{{ route('analisa.usaha.perdagangan', ['pengajuan' => $pengajuan]) }}"
            ...
            <a href="{{ route('analisa.usaha.pertanian', ['pengajuan' => $pengajuan]) }}"
            ...
            <a href="{{ route('analisa.usaha.jasa', ['pengajuan' => $pengajuan]) }}"
