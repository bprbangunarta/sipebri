        ...
        <div class="navbar navbar-light">
            <div class="container-xl">
                <ul class="navbar-nav">
                    ...
                    @can('menu admin')
                        <li
                            class="nav-item dropdown {{ request()->is('admin/role', 'admin/user', 'admin/kantor', 'admin/produk', 'admin/permission', 'admin/pendidikan') ? 'active' : '' }}">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item {{ request()->is('admin/permission') ? 'active' : '' }}"
                    ...
                    @can('menu analis')
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{ route('analisa.penjadwalan') }}">
                                    Penjadwalan
                                </a>

                                <a class="dropdown-item" href="{{ route('komite.komite') }}">
                                    Putusan Komite
                                </a>
