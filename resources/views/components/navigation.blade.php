            ...
            <li
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ request()->is('themes/rsc/penolakan') ? 'active' : '' }}">
                        <a href="{{ route('rsc.penolakan') }}" title="Add RSC">
                            <i class="fa fa-ban" aria-hidden="true"></i>
                            Add Penolakan RSC
                        </a>
                    </li> --}}
