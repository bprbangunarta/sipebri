                ...
                <div class="box-body" style="margin-top: -10px;font-size:12px;">
                    ...
                    <div class="div-left">
                        <div style="width: 100%;float:left;">
                            ...
                            <select class="form-control input-sm form-border text-uppercase" name="bi_checking" id="" required>
                                <option value="">--Pilih--</option>
                                <option value="4" {{ old('bi_checking') == 4 ? 'selected' : '' }}>Lancar</option>
                                <option value="3" {{ old('bi_checking') == 3 ? 'selected' : '' }}>Kurang Lancar</option>
                        ...
                        <div style="margin-top:5px;width: 49.5%;float:left;">
                            ...
                            <select class="form-control input-sm form-border text-uppercase" name="kewajiban1" id="">
                                <option value="">--Pilih--</option>
                        ...
                        <div style="margin-top:5px;width: 49.5%;float:left;">
                            <span class="fw-bold">KEWAJIBAN PIHAK LAIN</span>
                            <select class="form-control input-sm form-border text-uppercase" name="ket_kewajiban2" id="">
                                <option value="">--Pilih--</option>
                                <option value="Bank Umum" {{ old('ket_kewajiban2') == 5 ? 'selected' : '' }}>Bank Umum</option>
                                <option value="BPR" {{ old('ket_kewajiban2') == 4 ? 'selected' : '' }}>BPR</option>
                                <option value="Koperasi" {{ old('ket_kewajiban2') == 3 ? 'selected' : '' }}>Koperasi</option>
                        ...
                        <div style="margin-top:5px;width: 49.5%;float:left;">
                            <span class="fw-bold">KEWAJIBAN PIHAK LAIN</span>
                            <select class="form-control input-sm form-border text-uppercase" name="kewajiban3" id="">
                                <option value="">--Pilih--</option>
                    ...
                    <div class="div-right">
                        <div style="width: 49.5%;float:left;">
                            ...
                            <select class="form-control input-sm form-border text-uppercase" name="pihak_berwajib" id="" required>
                                <option value="">--Pilih--</option>
                                <option value="2" {{ old('pihak_berwajib') == 2 ? 'selected' : '' }}>Pernah</option>
                                <option value="1" {{ old('pihak_berwajib') == 1 ? 'selected' : '' }}>Tidak Pernah</option>
                            </select>
                        </div>

                        <div style="width: 49.5%;float:right;">
                            <span class="fw-bold">HUBUNGAN DENGAN TETANGGA</span>
                            <select class="form-control input-sm form-border text-uppercase" name="hubungan_tetangga" id="" required>
                                <option value="">--Pilih--</option>
                                <option value="Baik" {{ old('hubungan_tetangga') == 3 ? 'selected' : '' }}>Baik</option>
                                <option value="Cukup Baik" {{ old('hubungan_tetangga') == 2 ? 'selected' : '' }}>Cukup Baik</option>
                                <option value="Kurang Baik" {{ old('hubungan_tetangga') == 1 ? 'selected' : '' }}>Kurang Baik</option>
                            </select>
                        </div>

                        <div style="margin-top:5px;width: 49.5%;float:left;">
                            <span class="fw-bold">PENGALAMAN MENJADI TKI</span>
                            <select class="form-control input-sm form-border text-uppercase" name="pengalaman_tki" id="">
                                <option value="">--Pilih--</option>
                                <option value="Pernah" {{ old('pengalaman_tki') == 5 ? 'selected' : '' }}>Pernah</option>
                                <option value="Tidak Pernah" {{ old('pengalaman_tki') == 4 ? 'selected' : '' }}>Tidak Pernah</option>
                            </select>
                        </div>

                        <div style="margin-top:5px;width: 49.5%;float:right;">
                            <span class="fw-bold">KETERANGAN</span>
                            <select class="form-control input-sm form-border text-uppercase" name="ket_pengalaman" id="">
                                <option value="">--Pilih--</option>
                                <option value="Pemohon" {{ old('ket_pengalaman') == 5 ? 'selected' : '' }}>Pemohon</option>
                                <option value="Pendamping" {{ old('ket_pengalaman') == 4 ? 'selected' : '' }}>Pendamping</option>
                            </select>
                        </div>
                        ...
                        <div style="margin-top:5px;width: 100%;float:right;">
                            ...
                            <input type="text" class="form-control input-sm form-border text-uppercase" name="info_masyarakat" id="" placeholder="ENTRI">
                        </div>
                    </div>
