...
<script src="{{ asset('theme/assets/select2/dist/js/select2.full.min.js') }}"></script>
...
<script src="{{ asset('theme/assets/moment/min/moment.min.js') }}"></script>
<script src="{{ asset('theme/assets/bootstrap-daterangepicker/daterangepicker.js') }}"></script>
<script src="{{ asset('theme/assets/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js') }}"></script>
<script src="{{ asset('theme/assets/bootstrap-colorpicker/dist/js/bootstrap-colorpicker.min.js') }}"></script>
...
<script src="{{ asset('theme/assets/jquery-slimscroll/jquery.slimscroll.min.js') }}"></script>
