						...
						<div class="container-xl">
							<div class="row g-2 align-items-center">
								...
								<div class="col-auto ms-auto d-print-none">
									<div class="btn-list">
										<a href="{{ route('pengajuan.agunan') }}" class="btn btn-primary">
										...
										<div class="card-body">
											...
											<div class="row g-3">
												<div class="col-md">
													...
													<select type="text" class="form-select" placeholder="Pilih Surveyor"
														name="surveyor_kode" id="select-surveyor">
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function () {
    	var el;
    	window.TomSelect && (new TomSelect(el = document.getElementById('select-surveyor'), {
    		copyClassesToDropdown: false,
    		dropdownClass: 'dropdown-menu ts-dropdown',
    		optionClass:'dropdown-item',
    		controlInput: '<input>',
