...
<body>
    <div class="content">
        ...
        <img src="{{ asset('assets/img/pba.png') }}" style="width:300px;">
        <br>
        <br>
        <br>
        ...
        <p style="font-size: 12px; lin">Kepada Yth. <br> Bapak/Ibu YUDHA SAKTI PRATAMA / SITI IRHAMNAH KARWIYANTI <br>
            Di
        ...
        <br>
        <br>
        <img src="{{ asset('assets/img/pba.png') }}" style="width:300px; margin-top: 55px;">
        <br>
        <br>
        <table style="font-size: 12px;">
            <tr>
            ...
            <tr>
                ...
                <td style="width: 30%; text-align:justify;" colspan="3">b. Apabila debitur lalai dari kewajiban atau
                    tidak dapat mengangsur bunga dan atau pokok pinjaman selama 3 (tiga
                    ...
                    ini
                    Debitur tidak berhak untuk menolak, mempersulit, menghalang-halangi maaupun menghambat,</td>
            </tr>
            <tr>
                <td style="width: 30%; text-align:justify;" colspan="4">13. Debitur tidak diperbolehkan memberikan
                    ...
                    atau petugas
                    BANK dapat dikenakan sanksi sesuai ketentuan BANK.</td>
                <td></td>
            </tr>
            <tr>
                <td style="width: 30%; text-align:justify;" colspan="4">14. Notifikasi Kredit ini merupakan bagian
                    ...
                    Perjanjian Kredit Konsumsi Lainnya PT. BPR PAMANUKAN BANGUNARTA.
        ...
        <table style="font-size: 12px;">
            <tr>
                <td style="text-align:center;">Surat ini tidak memerlukan tanda tangan
        ...
        <table style="font-size: 12px; margin-top: 70px; border:1px black;">
            <tr>
                <td style=""></td>
