...
<body>
    ...
    <div class="content" style="margin-top: -57px;">
        ...
        <ol style="text-align: justify;margin-top:-1px;margin-left: -25px;">
            ...
            <li>
                PEMINJAM dan atau PENJAMIN dengan ini berjanji tidak akan menyewakan, menjual, menghilangkan dan
                memindahtangankan kepada pihak ketiga asset-asset yang berhubungan dengan jaminan-jaminan yang telah dan
                akan diserahkan kepada BANK tanpa persetujuan tertulis terlebih dahulu dari BANK. Setelah pinjaman
                dinyatakan lunas oleh BANK atau berdasarkan pertimbangan BANK barang agunan pada pasal 4 ayat 1 ini
                sudah tidak diperlukan lagi sebagai jaminan kredit, BANK wajib mengembalikan bukti-bukti pemilikan
                barang agunan tersebut kepada PEMINJAM.
            </li>
            <li>
                Bilamana barang jaminan pada Pasal 4 Ayat 1 diatas hilang, musnah, berkurang nilainya baik sebagian
                maupun seluruhnya, atau karena suatu hal berakhir penguasaannya oleh pihak yang berwenang, maka PEMINJAM
                berkewajiban dan bersedia mengganti dengan barang jaminan apapun lainnya yang nilainya oleh BANK
        ...
        <p style="text-align: justify;">
            ...
            sesuai jadwal angsuran pinjaman ditambah dengan penalti pelunasan sebesar <font class="text-hg">1 (satu)
                kali angsuran</font>.
        </p>
        ...
        <ol style="text-align: justify;margin-top:-1px;margin-left: -25px;">
            ...
            <li>
                Menjaminkan hak tagih BANK terhadap PEMINJAM berdasarkan Perjanjian Kredit ini kepada pihak lain yang
                ditunjuk atau ditentukan sendiri oleh BANK tanpa harus meminta persetujuan dari PEMINJAM atau
                penggantinya.
            </li>
        </ol>
        </p>
    ...
    <div class="content" style="margin-top: -57px;">
        ...
        <ol style="text-align: justify;margin-top:-1px;margin-left: -25px;">
            ...
            <li>
                Tindakan hukum sebagaimana Pasal 8 ayat 3 dalam perjanjian ini termasuk namun tidak terbatas
                diantaranya pengalihan piutang atas nama PEMINJAM oleh BANK kepada Kreditur Baru.
            </li>
            ...
            <li>
                ...
                accesoir-nya termasuk hak-hak atas jaminan kredit kepada pihak lain yang ditetapkan BANK sendiri setiap
        ...
        <p style="text-align: justify;">
            ...
            Bahwa PEMINJAM selama perjanjian kredit tidak tersangkut dalam perkara / sengketa berupa apa pun juga di
            muka Pengadilan dan / atau Instansi-instansi lainnya yang dapat mengancam harta kekayaan PEMINJAM dan dapat
            mempengaruhi kemampuan PEMINJAM untuk melaksanakan kewajiban-kewajibanya yang termaksud dalam perjanjian
            kredit ini. Apabila hal-hal seperti tersebut terjadi, maka BANK diprioritaskan pembayarannya dari hasil
            penjualan barang jaminan, hasil lelang dan kepailitan, selain yang ada berdasarkan perjanjian penyerahan
            jaminan.
        </p>
    ...
    <div class="content" style="margin-top: -57px;">
        ...
        <ol style="text-align: justify;margin-top:-1px;margin-left: -25px;">
            <li style="list-style-type: none;">
                pisahkan dari perjanjian ini yang tidak akan dibuat tanpa adanya kuasa-kuasa tersebut. Dan karenanya
                kuasa-kuasa tersebut dan kuasa yang ada dalam surat perjanjian ini tidak dapat dicabut kembali dan tidak
                akan berakhir karena sebab-sebab apapun juga, selama perjanjian ini berlangsung dan selama PEMINJAM
                belum melunasi seluruh hutangnya kepada BANK.
            </li>
            <li>
                ...
                <td>
                    <div class="content">
                        ...
                        <ol style="text-align: justify;margin-top:-1px;margin-left: -25px;">
                            ...
                            <li>
                                Menjaminkan hak tagih BANK terhadap PEMINJAM berdasarkan Perjanjian Kredit ini kepada
                                pihak lain yang
                                ditunjuk atau ditentukan sendiri oleh BANK tanpa harus meminta persetujuan dari PEMINJAM
                                atau
                                penggantinya.
                            </li>
                        </ol>
                        ...
                        <ol style="text-align: justify;margin-top:-1px;margin-left: -25px;">
                            <li style="list-style-type: none;">
                                pisahkan dari perjanjian ini yang tidak akan dibuat tanpa adanya kuasa-kuasa tersebut.
                                Dan karenanya
                                kuasa-kuasa tersebut dan kuasa yang ada dalam surat perjanjian ini tidak dapat dicabut
                                kembali dan tidak
                                akan berakhir karena sebab-sebab apapun juga, selama perjanjian ini berlangsung dan
                                selama PEMINJAM
                                belum melunasi seluruh hutangnya kepada BANK.
                            </li>
                            <li>
