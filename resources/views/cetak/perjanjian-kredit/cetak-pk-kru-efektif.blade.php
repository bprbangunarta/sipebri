                ...
                <td>
                    <div class="content">
                        ...
                        <ol style="text-align: justify;margin-top:-1px;margin-left: -25px;">
                            ...
                            @endif
                            <li>
                                Pembayaran angsuran pokok atas jumlah kredit yang terhutang oleh PEMINJAM kepada BANK
                                wajib dilakukan oleh PEMINJAM dan harus lunas pada tanggal
                                {{ $data->tgl_jth_tmp }}{{ $isi }} Sedangkan pembayaran bunga atas
                                jumlah kredit yang terhutang oleh PEMINJAM kepada BANK (selanjutnya disebut setoran
                                bunga) wajib dilakukan oleh PEMINJAM secara bulanan dalam
