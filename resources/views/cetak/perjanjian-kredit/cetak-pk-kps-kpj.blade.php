...
<body>
    ...
    <div class="content" style="margin-top: -57px;">
        ...
        <p style="text-align: justify;">
            ...
            tersebut akan diuraikan lebih lanjut dalam ketentuan dan syarat-syarat perjanjian kredit dalam pasal-pasal
            sebagai berikut :
        </p>
    ...
    <div class="content" style="margin-top: -57px;">
        ...
        <ol style="text-align: justify;margin-top:-1px;margin-left: -25px;">
            ...
            <li>
                ...
                PEMINJAM berhenti bekerja dengan maksimal jangka waktu 1 ( satu ) bulan setelah PEMINJAM berhenti
                bekerja.
            </li>
        </ol>
        </p>
        ...
        <p style="text-align: justify;">
            ...
            sesuai jadwal angsuran pinjaman ditambah dengan penalty pelunasan sebesar 15 % dari fasilitas kredit /
    ...
    <div class="content" style="margin-top: -57px;">
        ...
        <ol style="text-align: justify;margin-top:-1px;margin-left: -25px;">
            ...
            <li>
                Untuk keperluan tersebut pada Pasal 7 Ayat 1 di atas, PEMINJAM akan menyerahkan kepada BANK, Surat Kuasa
