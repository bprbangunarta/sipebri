...
<body>
    ...
    <div class="content" style="margin-top: -57px;">
        ...
        <ol start="4" style="text-align: justify;margin-top:-1px;margin-left: -25px;">
            <li>
                ...
                pemeliharaan serta biaya pemeriksaan barang-barang jaminan, dan PEMINJAM akan menerima baik perhitungan
                yang dibuat dan diberikan oleh BANK diatas dengan tanpa mengurangi hak PEMINJAM untuk membuktikan
                sebaliknya, dan apabila ada catatan BANK yang tidak benar, BANK akan melakukan pembetulan.
            </li>
        </ol>
        </p>
        ...
        <ol style="text-align: justify;margin-top:-1px;margin-left: -25px;">
            ...
            <li>
                PEMINJAM dan atau PENJAMIN dengan ini menyatakan dengan sebenarnya bahwa barang-barang jaminan tersebut
                diatas adalah hak milik secara sah dari PEMINJAM dan atau PENJAMIN baik secara hukum maupun phisik dan
                barang-barang tersebut dikuasai oleh PEMINJAM dan atau PENJAMIN baik sekarang maupun sampai dengan
                pinjaman tersebut di atas lunas atau pada saat BANK akan melaksanakan ketentuan Pasal 6 tersebut di
                bawah ini, tidak dalam keadaan dijaminkan atas sesuatu hutang pada pihak lain ataupun tidak tersangkut
                dalam perkara / sengketa baik di dalam maupun di luar pengadilan serta tidak ditaruh dibawah penyitaan
                jaminan ( conversatoir / revindicatoir beslag ) serta bebas dari segala beban hukum lain yang
                bagaimanapun sifatnya serta tidak diperoleh dari hasil perbuatan yang bertentangan dengan hukum yang
                berlaku.
            </li>
            <li>
                PEMINJAM dengan ini berjanji tidak akan mengambil seluruh atau sebagian manfaat dari dokumen/barang
                jaminan tersebut pada Pasal 4 Ayat 1, tanpa persetujuan tertulis terlebih dahulu dari BANK.
            </li>
            <li>
                PEMINJAM bersedia untuk menginformasikan kepada BANK, notifikasi terkait kepesertaan PEMINJAM pada BPJS
                Ketenagakerjaan / JAMSOSTEK yang dibutuhkan oleh BANK untuk kepentingan kredit PEMINJAM.
            </li>
            <li>
                Jika karena satu dan lain hal seperti Pemutusan Hubungan Kerja ( PHK ) dan lain sebagainya, PEMINJAM
                sudah tidak lagi mendapat manfaat dari barang jaminan tersebut pada Pasal 4 Ayat 1, maka dengan ini
                PEMINJAM berjanji dan menyatakan akan menyerahkan kepada BANK, seluruh dokumen yang diperlukan untuk
                pencairan saldo atas barang jaminan tersebut pada Pasal 4 Ayat 1 di atas.
            </li>
            <li>
                Dalam hal barang jaminan tersebut pada pasal 4 ayat 1 di atas mengalami pengurangan nilai baik sebagian
                maupun seluruhnya, atau karena suatu hal berakhir penguasaannya oleh PEMINJAM, maka PEMINJAM
                berkewajiban dan bersedia mengganti dengan barang jaminan lain yang nilainya oleh BANK dianggap cukup
                untuk melunasi hutang dan seluruh kewajiban PEMINJAM kepada BANK.
            </li>
            <li>
                Setelah pinjaman dinyatakan lunas oleh BANK atau berdasarkan pertimbangan BANK barang agunan tersebut
                pada pasal 4 ayat 1 ini sudah tidak diperlukan lagi sebagai jaminan kredit, BANK wajib mengembalikan
                bukti-bukti pemilikan barang agunan tersebut kepada PEMINJAM.
            </li>
            <li>
                PEMINJAM bersedia untuk melakukan pelunasan fasilitas kredit berdasarkan Pasal 1 perjanjian ini apabila
                PEMINJAM berhenti bekerja, selambat-lambatnya 1 (satu) bulan setelah PEMINJAM berhenti bekerja.
            </li>
        </ol>
        </p>
        ...
        <p style="text-align: justify;">
            ...
            sesuai jadwal angsuran pinjaman ditambah dengan penalti pelunasan sebesar <font class="text-center">15 %
    ...
    <div class="content" style="margin-top: -57px;">
        ...
        <ol style="text-align: justify;margin-top:-1px;margin-left: -25px;">
            <li>
                Memotong gaji PEMINJAM, untuk kewenangan ini PEMINJAM menyerahkan kepada BANK Surat Kuasa Pemotongan
                Gaji dari PEMINJAM kepada Pihak yang ditunjuk oleh BANK, termasuk tetapi tidak terbatas pada pemotongan
                gaji bulanan, tunjangan-tunjangan lainnya, dan hak-hak PEMINJAM saat terjadi Pemutusan Hubungan Kerja.
            </li>
            <li>
        ...
        <p style="text-align: justify;">
            ...
            PEMINJAM mengetahui dan setuju bahwa penutupan asuransi terkait dengan pinjaman ini, pada polisnya akan
            dipasang syarat BANKER’s Clouse yaitu apabila ada pembayaran dari asuransi akan diterima terlebih dahulu
            oleh BANK untuk membayar jumlah seluruh hutang PEMINJAM, apabila ada kelebihan akan dikembalikan pada
                    ...
                    <div class="content">
                        ...
                        <ol style="text-align: justify; margin-left: -25px;">
                            ...
                            <li>
                                ...
                                sampai dengan
                                pinjaman tersebut di atas lunas atau pada saat BANK akan melaksanakan ketentuan Pasal 6
                                tersebut di
                            ...
                            <li>
                                PEMINJAM dengan ini berjanji tidak akan mengambil seluruh atau sebagian manfaat dari
                                dokumen/barang
                                jaminan tersebut pada Pasal 4 Ayat 1, tanpa persetujuan tertulis terlebih dahulu dari
                                BANK.
                            </li>
                            <li>
                                PEMINJAM bersedia untuk menginformasikan kepada BANK, notifikasi terkait kepesertaan
                                PEMINJAM pada BPJS
                                Ketenagakerjaan / JAMSOSTEK yang dibutuhkan oleh BANK untuk kepentingan kredit PEMINJAM.
                            </li>
                            <li>
                                Jika karena satu dan lain hal seperti Pemutusan Hubungan Kerja ( PHK ) dan lain
                                sebagainya, PEMINJAM
                                sudah tidak lagi mendapat manfaat dari barang jaminan tersebut pada Pasal 4 Ayat 1, maka
                                dengan ini
                                PEMINJAM berjanji dan menyatakan akan menyerahkan kepada BANK, seluruh dokumen yang
                                diperlukan untuk
                                pencairan saldo atas barang jaminan tersebut pada Pasal 4 Ayat 1 di atas.
                            </li>
                            <li>
                                Dalam hal barang jaminan tersebut pada pasal 4 ayat 1 di atas mengalami pengurangan
                                nilai baik sebagian
                                maupun seluruhnya, atau karena suatu hal berakhir penguasaannya oleh PEMINJAM, maka
                                PEMINJAM
                                berkewajiban dan bersedia mengganti dengan barang jaminan lain yang nilainya oleh BANK
                                dianggap cukup
                                untuk melunasi hutang dan seluruh kewajiban PEMINJAM kepada BANK.
                            </li>
                            <li>
                                Setelah pinjaman dinyatakan lunas oleh BANK atau berdasarkan pertimbangan BANK barang
                                agunan tersebut
                                pada pasal 4 ayat 1 ini sudah tidak diperlukan lagi sebagai jaminan kredit, BANK wajib
                                mengembalikan
                                bukti-bukti pemilikan barang agunan tersebut kepada PEMINJAM.
                            </li>
                            <li>
                                PEMINJAM bersedia untuk melakukan pelunasan fasilitas kredit berdasarkan Pasal 1
                                perjanjian ini apabila
                                PEMINJAM berhenti bekerja, selambat-lambatnya 1 (satu) bulan setelah PEMINJAM berhenti
                                bekerja.
                            </li>
                        </ol>
                        </p>
                        ...
                        <p style="text-align: justify;">
                        <ol start="1" style="text-align: justify; margin-left: -25px;">
                            <li>
                                PEMINJAM menyetujui bahwa pembukuan BANK selalu menjadi dasar untuk menetapkan jumlah
                                hutang yang wajib
                                dibayar oleh PEMINJAM kepada BANK berdasarkan Perjanjian Kredit ini, baik jumlah pokok,
