...
<body>
    ...
    <div class="content" style="margin-top: -57px;">
        ...
        <p style="text-align: justify;">
            ...
            sesuai jadwal angsuran pinjaman ditambah dengan penalti pelunasan sebesar <font class="text-hg">3,00%</font>
            ...
            <tr>
                <td>
                    <div class="content">
                        ...
                        <ol style="text-align: justify;margin-top:-1px;margin-left: -25px;">
                            <li>
                                Pembayaran angsuran pokok berikut bunga atas jumlah kredit yang terhutang oleh
                                ...
                                <font class="text-hg">{{ $data->jwt }}</font> ( <font class="text-hg"
                                    ...
                                    class="text-hg">kali
                                    angsuran</font> setiap tanggal {{ $data->tgl_jth }} ( selanjutnya disebut
                                tanggal angsuran ) yang
                                dimulai
