                ...
                <td>
                    <div class="content">
                        ...
                        <ol style="text-align: justify;margin-top:-1px;margin-left: -25px;">
                            <li>
                                Bunga sebesar <font class="text-hg">{{ $data->suku_bunga }} % </font> pertahun dihitung
                                secara merata setiap bulannya.
                            </li>
                            <li>
                        ...
                        <ol style="text-align: justify;margin-top:-1px;margin-left: -25px;">
                            <li>
                                ...
                                <font class="text-hg">{{ $data->jwt }}</font> ( <font class="text-hg"
                                    ...
                                    class="text-hg">kali angsuran</font> setiap tanggal {{ $data->tgl_jth }} (
                                selanjutnya disebut tanggal angsuran ) yang dimulai pada ​tanggal
                                {{ $data->tgl_bln_thn_tempo }} dan demikian seterusnya hingga berakhir pada tanggal
                                {{ $data->tgl_jth_tmp }}.
                            </li>
                            <li>
                        ...
                        <ol style="text-align: justify;margin-top:-1px;margin-left: -25px;">
                            <li>
                                ...
                                agunan-agunan baik dalam rangka penilaian
                                kembali maupun dalam rangka pemeriksaan dan pengawasan (monitoring), apabila hal ini
                                dianggap perlu oleh BANK.
                            </li>
                            <li>
                                Menelepon dan/atau mengunjungi PEMINJAM atau pasangan PEMINJAM tanpa pembatasan
                                jam/waktu dan hari pada nomor telepon
                                PEMINJAM atau pasangan PEMINJAM pada domisili yang telah ditetapkan dalam Perjanjian
                                Kredit ini, atau pada tempat/domisili
                                senyatanya PEMINJAM atau pengganti PEMINJAM atau pada tempat tinggal lain yang diketahui
                                oleh BANK.
                            </li>
                            <li>
                                Apabila PEMINJAM sulit dihubungi atau sulit ditemui pada nomor telepon PEMINJAM/pasangan
                                PEMINJAM atau pada domisili yang
                                telah dipilih dalam Perjanjian Kredit ini atau domisili nyata PEMINJAM yang diketahui
                                oleh BANK, BANK dapat menghubungi
                                dan/atau menemui PEMINJAM/pasangan PEMINJAM pada nomor atau pada tempat kerja/perusahaan
                                PEMINJAM/pasangan
                                PEMINJAM, satu dan lain untuk menjaga kesinambungan komunikasi atau efektivitas
                                pemberitahuan/penyampaian informasi yang
                                berkaitan dengan pinjaman, pengelolaan pinjaman dan/atau jaminan/agunan, atau proses
                                penyelesaian pinjaman/agunan.
                            </li>
                        </ol>
                        </p>
                        ...
                        <ol style="text-align: justify;margin-top:-1px;margin-left: -25px;">
                            ...
                            <li>
                                ...
                                melakuk pemasangan
                                papan pemberitahuan didepan rumah dan atau tanah agunan dengan tulisan “RUMAH DAN / ATAU
                                TANAH INI
                                MERUPAKAN JAMINAN PINJAMAN DI PT BPR BANGUNARTA”.
                            </li>
                            <li>
                                Bilamana PEMINJAM dalam keadaan ingkar janji, maka PEMINJAM setuju bahwa BANK berhak
                                untuk melakukan tindakan
                                hukum yang diperlukan sesuai ketentuan yang berlaku, baik yang diatur dalam perjanjian
                                ini, maupun yang diatur oleh
                                Undang-Undang terkait dengan jaminan / agunan.
                        ...
                        <p style="text-align: justify;">
                            ...
                            BANK berhak menagih kekurangannya pada PEMINJAM.
                        </p>
