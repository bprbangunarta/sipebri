...
<head>
    ...
    <title>Lembar Konfirmasi Kredit</title>
    <style>
        @page {
            size: A4;
            margin: 1;
    ...
    <div class="content">
        ...
        <table class="cont">
            ...
            <tr>
                ...
                <td>Nasabah telah membaca dan memahami sepenuhnya manfaat dari Fasilitas Kredit yang akan didapatkannya.
                </td>
                <td></td>
                <td></td>
            </tr>
            <tr>
                ...
                <td>Nasabah telah membaca, menimbang, dan memahami sepenuhnya risiko atas Fasilitas Kredit yang akan
                    didapatkannya.</td>
                <td></td>
                <td></td>
            </tr>
        ...
        <p>Kesimpulan atas konfirmasi pemahaman Nasabah terkait Perjanjian Kredit :</p>
        <p>
        <div style="display: inline-block; border: 1px solid black; width: 10px; height: 10px;"></div> &nbsp; Nasabah
        telah memahami isi dari Perjanjian Kredit
        </p>

        <p>
        <div style="display: inline-block; border: 1px solid black; width: 10px; height: 10px;"></div> &nbsp; Nasabah
        tidak memahami isi dari Perjanjian Kredit
        </p>
