                                ...
                                <tr>
                                    ...
                                    <td style="display:flex; justify-content:center;">
                                        <select type="text" class="form-control" style="width: 50%; " name="dppspm"
                                            ...
                                            <option value="TIDAK TERDAFTAR" {{ empty($dppspm) ? 'selected' : '' }}>
                                                TIDAK
                                                TERDAFTAR
                                            </option>
                                        </select>
                                ...
                                <tr>
                                    ...
                                    <td style="display:flex; justify-content:center;">
                                        <select type="text" class="form-control" style="width: 50%; " name="pep"
                                            id="">
                                            <option value="TERDAFTAR" {{ $pep == 'TERDAFTAR' ? 'selected' : '' }}>
                                                TERDAFTAR
                                            </option>
                                ...
                                <tr>
                                    ...
                                    <td style="display:flex; justify-content:center;">
                                        <select type="text" class="form-control" style="width: 50%; " name="watch_list"
                                            id="">
                                            <option value="TERDAFTAR" {{ !empty($watch_list) ? 'selected' : '' }}>
                                                TERDAFTAR
                                            </option>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="display:flex; justify-content:center;">
                                        <select type="text" class="form-control" style="width: 50%; " name="dttot"
                                            ...
                                            <option value="TERDAFTAR" {{ !empty($dttot) ? 'selected' : '' }}>
                                                TERDAFTAR</option>
                                            <option value="TIDAK TERDAFTAR" {{ empty($dttot) ? 'selected' : '' }}>
                                                TIDAK
                                                TERDAFTAR
                                            </option>
                                        </select>
                                ...
                                <tr>
                                    ...
                                    <td style="display:flex; justify-content:center;">
                                        <select type="text" class="form-control" style="width: 50%; " name="dppspm"
                                            id="">
                                            <option value="TERDAFTAR" {{ !empty($dppspm) ? 'selected' : '' }}>
                                                TERDAFTAR
                                            </option>
                                            <option value="TIDAK TERDAFTAR" {{ empty($dppspm) ? 'selected' : '' }}>
                                                TIDAK
                                ...
                                <tr>
                                    ...
                                    <td style="display:flex; justify-content:center;">
                                        <select type="text" class="form-control" style="width: 50%; "
                                            name="judi_online" id="">
                                            <option value="TERDAFTAR" {{ !empty($judi) ? 'selected' : '' }}>
                                                TERDAFTAR
                                            </option>
                                            <option value="TIDAK TERDAFTAR" {{ empty($judi) ? 'selected' : '' }}>
                                                TIDAK
                                                TERDAFTAR
                                            </option>
                                        </select>
