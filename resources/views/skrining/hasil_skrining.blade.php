...
<div class="tab-content">
    <div class="tab-pane active">
        ...
        <div class="box-body table-responsive" style="width: 100%; height:425px;">
            ...
            @if ($status == 'TERDAFTAR')
            <form action="{{ route('daftar.analisa.skrining') }}" method="get">
                @csrf
                        ...
                        <tr>
                            ...
                            <td style="display:flex; justify-content:center;">
                                <select type="text" class="form-control" style="width: 50%; " name="dttot"
                                    id="">
                                    <option value="TERDAFTAR" {{ !empty($dttot) ? 'selected' : '' }}>TERINDIKASI</option>
                                    <option value="TIDAK TERDAFTAR" {{ empty($dttot) ? 'selected' : '' }}>TIDAK TERINDIKASI</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="display:flex; justify-content:center;">
                                <select type="text" class="form-control" style="width: 50%; " name="dppspm"
                                    id="">
                                    <option value="TERDAFTAR" {{ !empty($dppspm) ? 'selected' : '' }}>TERINDIKASI</option>
                                    <option value="TIDAK TERDAFTAR" {{ empty($dppspm) ? 'selected' : '' }}>TIDAK TERINDIKASI</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="display:flex; justify-content:center;">
                                <select type="text" class="form-control" style="width: 50%; " name="judi_online"
                                    id="">
                                    <option value="TERDAFTAR" {{ !empty($judi) ? 'selected' : '' }}>TERINDIKASI</option>
                                    <option value="TIDAK TERDAFTAR" {{ empty($judi) ? 'selected' : '' }}>TIDAK TERINDIKASI</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="display:flex; justify-content:center;">
                                <select type="text" class="form-control" style="width: 50%; " name="pep"
                                    id="">
                                    <option value="TERDAFTAR" {{ $pep == 'TERDAFTAR' ? 'selected' : '' }}>TERINDIKASI</option>
                                    <option value="TIDAK TERDAFTAR" {{ $pep == 'TIDAK TERDAFTAR' ? 'selected' : '' }}>TIDAK TERINDIKASI</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="display:flex; justify-content:center;">
                                <select type="text" class="form-control" style="width: 50%; "
                                    ...
                                    <option value="TERDAFTAR" {{ !empty($negative_news) ? 'selected' : '' }}>TERINDIKASI</option>
                                    <option value="TIDAK TERDAFTAR" {{ empty($negative_news) ? 'selected' : '' }}>TIDAK TERINDIKASI</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="display:flex; justify-content:center;">
                                <select type="text" class="form-control" style="width: 50%; " name="watch_list"
                                    id="">
                                    <option value="TERDAFTAR" {{ !empty($watch_list) ? 'selected' : '' }}>TERINDIKASI</option>
                                    <option value="TIDAK TERDAFTAR" {{ empty($watch_list) ? 'selected' : '' }}>TIDAK TERINDIKASI</option>
                                </select>
                            </td>
                        </tr>
                    </tbody>
            ...
            <form action="{{ route('skrining.cetak') }}" method="get" target="_blank">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <button type="submit" class="btn btn-sm btn-primary" style="margin-top:20px;width:100%">
