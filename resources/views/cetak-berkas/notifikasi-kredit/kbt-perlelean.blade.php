    ...
    <div class="content" style="margin-top: -57px;">
        ...
        <table>
            ...
            <tr>
                ...
                <td class="text-center" width="1%"> : </td>
                <td style="text-align: justify;">{{ $data->jwt }} ( <font style="text-transform: capitalize;">
                        {{ Riskihajar\Terbilang\Facades\Terbilang::make($data->jwt) }}</font> ) bulan terhitung sejak
                    akad kredit.</td>
            </tr>
            <tr>
