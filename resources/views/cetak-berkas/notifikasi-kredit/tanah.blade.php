    ...
    <div class="content" style="margin-top: -57px;">
        ...
        <table>
            ...
            <tr>
                ...
                <td class="text-center" width="1%"> : </td>
                <td style="text-align: justify;">18 % FLAT / Tahun</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="text-center" width="3%"> : </td>
                <td style="text-align: justify;">3.50 % dari plafon kredit</td>
            </tr>
            <tr>
                <td class="text-center" width="2%"></td>
                <td width="27%">a. Provisi Sebesar</td>
                <td class="text-center" width="3%"> : </td>
                <td style="text-align: justify;">1.00 % Rp. 300.000</td>
            </tr>
            <tr>
                <td class="text-center" width="2%"></td>
        ...
        <table>
            <tr>
                ...
                <td width="27%">Untuk Jaminan Non Kendaraan</td>
            ...
            <tr>
                ...
                <td style="text-align: justify;">
                    <ol type='a' style="margin-left: -20px;margin-top:-1px;tetxt-align:justify;">
                        ...
                        <li>
                            Apabila debitur lalai dari kewajiban atau tidak dapat mengangsur bunga dan atau pokok pinjaman selama 3 (tiga) bulan atau lebih, maka Bank berhak melakukan tindakan-tindakan yang mendorong untuk penyelesaian tunggakan termasuk dalam hal ini BANK melakkukan tindakan pemasangan plakat "TANAH INI SEDANG DIJAMINKAN KE BPR BANGUNARTA" sampai tunggakan tersebut dapat terselesaikan atau Bank melakukan upaya-upaya yang mengarah pada penguasaan agunan untuk penyelesaian kredit tersebut dan dalam hal ini Debitur tidak berhak untuk menolak, mempersulit, menghalang-halangi, maupun menghambat.
                        </li>
                    </ol>
                </td>
            </tr>
