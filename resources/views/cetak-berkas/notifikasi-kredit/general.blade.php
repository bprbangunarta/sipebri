      ...
      <table>
         ...
         <tr>
            ...
            <td style="text-align: justify;">{{ $data->sandi_sektor_ekonomi }}.
               {{ $data->keterangan_sektor_ekonomi }}
            </td>
         </tr>
         ...
         <tr>
            ...
            <td style="text-align: justify;">
               {{ $data->count_jaminan }} ( <font style="text-transform: capitalize;">
                  {{ Riskihajar\Terbilang\Facades\Terbilang::make($data->count_jaminan) }}
               </font> ) <br>
         ...
         <tr>
            ...
            <td style="text-align: justify;">
               Wajib dilakukan dalam {{ $data->jw }} ( <font style="text-transform: capitalize;">
                  {{ Riskihajar\Terbilang\Facades\Terbilang::make($data->jw) }}
               </font> ) kali angsuran, yang
               dibayarkan setiap
               ...
               dibayarkan {{ $data->awal_angsuran }} ( <font style="text-transform: capitalize;">
                  {{ Riskihajar\Terbilang\Facades\Terbilang::make($data->awal_angsuran) }}
               </font> ) bulan
               setelah
               tanggal akad kredit.
            </td>
         ...
         <tr>
            ...
            <td class="text-center" width="3%"> : </td>
            <td style="text-align: justify;">
               {{ 'Rp. ' . '' . number_format($data->asuransi_jiwa_menurun2, 0, ',', '.') }}
            </td>
         </tr>
         <tr>
            <td class="text-center" width="2%"></td>
