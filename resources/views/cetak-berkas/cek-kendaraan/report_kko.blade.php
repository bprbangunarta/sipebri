        ...
        <table style="border:1px solid black;">
            ...
            <tbody>
                ...
                <tr style="border:1px solid black;">
                    ...
                    <td style="border:1px solid black;">&nbsp; Surat Kuasa Potong Gaji</td>
                    <td style="border:1px solid black;text-align:right;">
                        &nbsp;
                    </td>
                    <td style="border:1px solid black;text-align:right;"></td>
                ...
                <tr style="border:1px solid black;">
                    ...
                    <td style="border:1px solid black;">&nbsp; Fotocopy SK Pegawai</td>
                    <td style="border:1px solid black;text-align:right;">
                        &nbsp;
                    </td>
                    <td style="border:1px solid black;text-align:right;"></td>
                ...
                <tr style="border:1px solid black;">
                    ...
                    <td style="border:1px solid black;">&nbsp; Fotocopy SP Dealer</td>
                    <td style="border:1px solid black;text-align:right;">
                        &nbsp;
                    </td>
                    <td style="border:1px solid black;text-align:right;"></td>
                ...
                <tr style="border:1px solid black;">
                    ...
                    <td style="border:1px solid black;">&nbsp; Foto Agunan Kendaraan Mobil / Motor</td>
                    <td style="border:1px solid black;text-align:right;">
                        &nbsp;
                    </td>
                    <td style="border:1px solid black;text-align:right;"></td>
                ...
                <tr style="border:1px solid black;">
                    ...
                    <td style="border:1px solid black;">&nbsp; Gosok Nomor Mesin dan Nomor Rangka Kendaraan</td>
                    <td style="border:1px solid black;text-align:right;">
                        &nbsp;
                    </td>
                    <td style="border:1px solid black;text-align:right;"></td>
                ...
                <tr style="border:1px solid black;">
                    ...
                    <td style="border:1px solid black;">&nbsp; Berita Acara Pemeriksaan Kendaraan Bermotor R2</td>
                    <td style="border:1px solid black;text-align:right;">
                        &nbsp;
                    </td>
                    <td style="border:1px solid black;text-align:right;"></td>
                ...
                <tr style="border:1px solid black;">
                    ...
                    <td style="border:1px solid black;">&nbsp; Surat Pernyataan Asuransi TLO</td>
                    <td style="border:1px solid black;text-align:right;">
                        &nbsp;
                    </td>
                    <td style="border:1px solid black;text-align:right;"></td>
                ...
                <tr style="border:1px solid black;">
                    ...
                    <td style="border:1px solid black;">&nbsp; Slip Gaji 1 Bulan Terakhir</td>
                    <td style="border:1px solid black;text-align:right;">
                        &nbsp;
                    </td>
                    <td style="border:1px solid black;text-align:right;"></td>
                ...
                <tr style="border:1px solid black;">
                    ...
                    <td style="border:1px solid black;">&nbsp; Form Memorandum Usulan Kredit ( MUK )</td>
                    <td style="border:1px solid black;text-align:right;">
                        &nbsp;
                    </td>
                    <td style="border:1px solid black;text-align:right;"></td>
                ...
                <tr style="border:1px solid black;">
                    ...
                    <td style="border:1px solid black;">&nbsp; Form Analisa Tambahan</td>
                    <td style="border:1px solid black;text-align:right;">
                        &nbsp;
                    </td>
                    <td style="border:1px solid black;text-align:right;"></td>
                ...
                <tr style="border:1px solid black;">
                    ...
                    <td style="border:1px solid black;">&nbsp; Form Trade Checking</td>
                    <td style="border:1px solid black;text-align:right;">
                        &nbsp;
                    </td>
                    <td style="border:1px solid black;text-align:right;"></td>
