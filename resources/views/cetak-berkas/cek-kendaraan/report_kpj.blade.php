        ...
        <table style="border:1px solid black;">
            ...
            <tbody>
                ...
                <tr style="border:1px solid black;">
                    ...
                    <td style="border:1px solid black;">&nbsp; Surat Kuasa Pendebetan Rekening</td>
                    <td style="border:1px solid black;text-align:right;">
                        &nbsp;
                    </td>
                    <td style="border:1px solid black;text-align:right;"></td>
                ...
                <tr style="border:1px solid black;">
                    ...
                    <td style="border:1px solid black;">&nbsp; Fotocopy Kartu Jamsostek</td>
                    <td style="border:1px solid black;text-align:right;">
                        &nbsp;
                    </td>
                    <td style="border:1px solid black;text-align:right;"></td>
                ...
                <tr style="border:1px solid black;">
                    ...
                    <td style="border:1px solid black;">&nbsp; Fotocopy Ijazah</td>
                    <td style="border:1px solid black;text-align:right;">
                        &nbsp;
                    </td>
                    <td style="border:1px solid black;text-align:right;"></td>
                ...
                <tr style="border:1px solid black;">
                    ...
                    <td style="border:1px solid black;">&nbsp; Slip Gaji 3 Bulan Terakhir</td>
                    <td style="border:1px solid black;text-align:right;">
                        &nbsp;
                    </td>
                    <td style="border:1px solid black;text-align:right;"></td>
                ...
                <tr style="border:1px solid black;">
                    ...
                    <td style="border:1px solid black;">&nbsp; Foto Selfie Pelaksanaan Survey</td>
                    <td style="border:1px solid black;text-align:right;">
                        &nbsp;
                    </td>
                    <td style="border:1px solid black;text-align:right;"></td>
