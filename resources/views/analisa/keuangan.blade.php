                ...
                <div class="col d-flex flex-column">
                  <div class="card-body">
                    ...
                    <table class="table table-bordered table-vcenter fs-5">
                      ...
                      <thead>
                        <tr>
                          <th><input class="form-control" disabled="" value="Usaha Perdagangan"></th>
                          <td><input type="text" class="form-control" readonly="" value="Rp. "></td>
                        </tr>
                        <tr>
                          <th><input class="form-control" disabled="" value="Usaha Pertanian"></th>
                          <td><input type="text" class="form-control" readonly="" value="Rp. "></td>
                        </tr>
                        <tr>
                          <th><input class="form-control" disabled="" value="Usaha Jasa"></th>
                          <td><input type="text" class="form-control" readonly="" value="Rp. "></td>
                        </tr>
                        <tr>
                          <th><input class="form-control" disabled="" value="Usaha Lainnya"></th>
                          <td><input type="text" class="form-control" readonly="" value="Rp. "></td>
                        </tr>
                      </thead>
                    </table>
                    ...
                    <table class="table table-bordered table-vcenter fs-5">
                      ...
                      <tbody>
                        <tr>
                          <th><input class="form-control" disabled="" value="Biaya Konsumsi Pokok"></th>
                          <td><input type="text" class="form-control" placeholder="Masukan Nominal"></td>
                        </tr>
                        <tr>
                          <th><input class="form-control" disabled="" value="Kesehatan"></th>
                          <td><input type="text" class="form-control" placeholder="Masukan Nominal"></td>
                        </tr>
                        <tr>
                          <th><input class="form-control" disabled="" value="Pendidikan"></th>
                          <td><input type="text" class="form-control" placeholder="Masukan Nominal"></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <th><input class="form-control" disabled="" value="Jajan Anak"></th>
                          <td><input type="text" class="form-control" placeholder="Masukan Nominal"></td>
                        </tr>
                        <tr>
                          <th><input class="form-control" disabled="" value="Sumbangan Sosial"></th>
                          <td><input type="text" class="form-control" placeholder="Masukan Nominal"></td>
                        </tr>
                        <tr>
                          <th><input class="form-control" disabled="" value="Rokok"></th>
                          <td><input type="text" class="form-control" placeholder="Masukan Nominal"></td>
                        </tr>
                      </tbody>
                    </table>
                    ...
                    <table class="table table-bordered table-vcenter fs-5">
                      ...
                      <tbody>
                        <tr>
                          <td><input type="text" class="form-control" placeholder="Nama Kewajiban"></td>
                          <td><input type="text" class="form-control" placeholder="Masukan Nominal"></td>
                        </tr>
                        <tr>
                          <td><input type="text" class="form-control" placeholder="Nama Kewajiban"></td>
                    ...
                    <table class="table table-bordered table-vcenter fs-5">
                      ...
                      <thead>
                        ...
                        <tr>
                          <th><input class="form-control" disabled="" value="Biaya Rumah Tangga"></th>
                          <td><input type="text" class="form-control" readonly="" value="Rp. "></td>
                        </tr>
                        <tr>
                          <th><input class="form-control" disabled="" value="Kewajiban Lainnya"></th>
                          <td><input type="text" class="form-control" readonly="" value="Rp. "></td>
                        </tr>
                        <tr>
                          <th><input class="form-control fw-bold" disabled="" value="Keuangan Perbulan"></th>
