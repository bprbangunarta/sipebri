                                        ...
                                        <div class="card-body">
                                            ...
                                            <table class="table table-bordered table-vcenter fs-5">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <th><input class="form-control" readonly value="Gatel"></th>
                                                        <td><input type="text" class="form-control"
                                                                placeholder="Masukan Nominal"></td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        <th><input class="form-control" readonly value="Sumbangan Sosial">
                                                        </th>
                                                        <td><input type="text" class="form-control"
                                                                placeholder="Masukan Nominal"></td>
                                                    </tr>
                                                    <tr>
                                                        <th><input class="form-control" readonly value="Rokok">
                                                        </th>
                                                        <td><input type="text" class="form-control"
                                                                placeholder="Masukan Nominal"></td>
                                                    </tr>
