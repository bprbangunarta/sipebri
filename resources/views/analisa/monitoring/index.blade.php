                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            ...
                            <h3 class="box-title">MONITORING STAFF ANALIS</h3>
                                    ...
                                    @forelse ($data as $item)
                                        <tr>
                                            ...
                                            <td class="text-center" style="vertical-align: middle;">
                                                ...
                                                <a
                                                    href="{{ route('monitoring.detail', ['name' => $item->nama_user, 'user' => $item->code_user, 'status' => 'Proses Survei']) }}">{{ $item->total_survei }}</a>
                                            </td>
                                            <td class="text-center" style="vertical-align: middle;">
                                                <a
                                            ...
                                            <td class="text-center" style="vertical-align: middle;"><a
                                                    href="{{ route('monitoring.detail.status', ['name' => $item->nama_user, 'user' => $item->code_user, 'trc' => 'Ditolak']) }}">{{ $item->total_tolak }}</a>
                                            </td>
                                        </tr>
                                    @empty
                                        <tr>
