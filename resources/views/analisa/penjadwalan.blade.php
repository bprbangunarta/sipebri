    ...
    <div class="tab-content">
        <div class="tab-pane active">
            ...
            <div class="box-header with-border">
                ...
                <h3 class="box-title">PENJADWALAN SURVEI</h3>
                            ...
                            <tr>
                                ...
                                <td class="text-center" style="vertical-align: middle;">
                                    ...
                                    <a data-toggle="modal" data-target="#info-{{ $item->kode_pengajuan }}"
                                        class="btn-circle btn-sm bg-blue" title="Informasi" style="cursor: pointer">
                                        <i class="fa fa-eye"></i>
                                    </a>
                                </td>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer" style="margin-top: -10px;">
                                                <button type="submit" class="btn bg-blue" data-dismiss="modal"
