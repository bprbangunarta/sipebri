                ...
                <div class="col d-flex flex-column">
                  ...
                  <div class="card-body">
                    <table class="table table-bordered table-vcenter fs-5">
                      <thead>
                        <tr>
                          <th class="text-center" colspan="6">Informasi Usaha Lainnya</th>
                        </tr>
                        <tr>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="text-center">
                            <a href="{{ route('analisa.usaha.lainnya.detail') }}">
  ...
  <div class="modal-dialog modal-xs modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Tambah Usaha Lainnya</h5>
          ...
          <div class="row">
            ...
            <div class="col-lg-12">
              <div class="mb-3">
                ...
                <select type="text" class="form-select" placeholder="Pilih Jenis Usaha" name="jenis_usaha"
                  id="select-usaha">
...
<script>
  document.addEventListener("DOMContentLoaded", function() {
            var el;
            window.TomSelect && (new TomSelect(el = document.getElementById('select-usaha'), {
