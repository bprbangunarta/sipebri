                ...
                <div class="col d-flex flex-column">
                  ...
                  <div class="card-body">
                    <table class="table table-bordered table-vcenter fs-5">
                      <thead>
                        <tr>
                          <th class="text-center" colspan="6">Informasi Usaha Jasa</th>
                        </tr>
                        <tr>
                      ...
                      <tbody>
                        <tr>
                          <td>Karyawan Taekwang</td>
                          <td>Rp. 10.000.000</td>
                          <td>Rp. 4.000.000</td>
                          <td>Rp. 6.000.000</td>
                          <td class="text-center">
                            <a href="{{ route('analisa.usaha.jasa.detail') }}">
  ...
  <div class="modal-dialog modal-xs modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Tambah Usaha Jasa</h5>
