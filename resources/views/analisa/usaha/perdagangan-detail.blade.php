                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="" placeholder="Nama Item"></td>
                                                        <td><input class="form-control input-harga" type="text"
                                                                name="" id="hrg1" placeholder="Nominal"></td>
                                                        <td><input class="form-control input-jual" type="text"
                                                                name="" id="jual1" placeholder="Nominal"></td>
                                                        <td><input class="form-control" type="text" name=""
                                                        ...
                                                        <td><input class="form-control text-center input-persen"
                                                                type="text" name="" id="persen1" disabled="">
                                                        </td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="" placeholder="Nama Item"></td>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="hrg2" placeholder="Nominal"></td>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="jual2" placeholder="Nominal"></td>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="laba2" placeholder="Nominal" readonly></td>
                                                        <td><input class="form-control text-center" type="number"
                                                                name="" id="stock2"></td>
                                                        <td><input class="form-control text-center" type="text"
                                                                name="" id="persen2" disabled=""></td>
                                                    </tr>
                                                    <tr>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="" placeholder="Nama Item"></td>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="hrg3" placeholder="Nominal"></td>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="jual3" placeholder="Nominal"></td>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="laba3" placeholder="Nominal" readonly></td>
                                                        <td><input class="form-control text-center" type="number"
                                                                name="" id="stock3"></td>
                                                        <td><input class="form-control text-center" type="text"
                                                                name="" id="persen3" disabled=""></td>
                                                    </tr>
                                                    <tr>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="" placeholder="Nama Item"></td>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="hrg4" placeholder="Nominal"></td>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="jual4" placeholder="Nominal"></td>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="laba4" placeholder="Nominal" readonly></td>
                                                        <td><input class="form-control text-center" type="number"
                                                                name="" id="stock4"></td>
                                                        <td><input class="form-control text-center" type="text"
                                                                name="" id="persen4" disabled=""></td>
                                                    </tr>
                                                    <tr>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="" placeholder="Nama Item"></td>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="hrg5" placeholder="Nominal"></td>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="jual5" placeholder="Nominal"></td>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="laba5" placeholder="Nominal" readonly></td>
                                                        <td><input class="form-control text-center" type="number"
                                                                name="" id="stock5"></td>
                                                        <td><input class="form-control text-center" type="text"
                                                                name="" id="persen5" disabled=""></td>
                                                    </tr>
                                                    <tr>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="" placeholder="Nama Item"></td>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="hrg6" placeholder="Nominal"></td>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="jual6" placeholder="Nominal"></td>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="laba6" placeholder="Nominal" readonly></td>
                                                        <td><input class="form-control text-center" type="number"
                                                                name="" id="stock6"></td>
                                                        <td><input class="form-control text-center" type="text"
                                                                name="" id="persen6" disabled=""></td>
                                                    </tr>
                                                    <tr>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="" placeholder="Nama Item"></td>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="hrg7" placeholder="Nominal"></td>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="jual7" placeholder="Nominal"></td>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="laba7" placeholder="Nominal" readonly></td>
                                                        <td><input class="form-control text-center" type="number"
                                                                name="" id="stock7"></td>
                                                        <td><input class="form-control text-center" type="text"
                                                                name="" id="persen7" disabled=""></td>
                                                    </tr>
                                                    <tr>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="" placeholder="Nama Item"></td>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="hrg8" placeholder="Nominal"></td>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="jual8" placeholder="Nominal"></td>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="laba8" placeholder="Nominal" readonly></td>
                                                        <td><input class="form-control text-center" type="number"
                                                                name="" id="stock8"></td>
                                                        <td><input class="form-control text-center" type="text"
                                                                name="" id="persen8" disabled=""></td>
                                                    </tr>
                                                    <tr>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="" placeholder="Nama Item"></td>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="hrg9" placeholder="Nominal"></td>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="jual9" placeholder="Nominal"></td>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="laba9" placeholder="Nominal" readonly></td>
                                                        <td><input class="form-control text-center" type="number"
                                                                name="" id="stock9"></td>
                                                        <td><input class="form-control text-center" type="text"
                                                                name="" id="persen9" disabled=""></td>
                                                    </tr>
                                                    <tr>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="" placeholder="Nama Item"></td>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="hrg10" placeholder="Nominal"></td>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="jual10" placeholder="Nominal"></td>
                                                        <td><input class="form-control" type="text" name=""
                                                                id="laba10" placeholder="Nominal" readonly></td>
                                                        <td><input class="form-control text-center" type="number"
                                                                name="" id="stock10"></td>
                                                        <td><input class="form-control text-center" type="text"
                                                                name="" id="persen10" disabled=""></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                            <table class="table table-bordered table-vcenter fs-5">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td><input class="form-control text-center" type="text"
                                                                name="" id="tstock" disabled=""></td>
                                                        <td><input class="form-control text-center" type="text"
                                                                name="" id="tpersen" disabled=""></td>
                                                    </tr>
                                                </tbody>
                                            </table>
