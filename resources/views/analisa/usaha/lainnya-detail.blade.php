                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><input type="text" class="form-control"
                                                                    ...
                                                                    id="nominal1" value="{{ old('nominal1') }}"></td>
                                                        </tr>
                                                        <tr>
                                                            <td><input type="text" class="form-control"
                                                            ...
                                                            <td><input type="text" class="form-control"
                                                                    ...
                                                                    id="nominal2" value="{{ old('nominal2') }}"></td>
                                                        </tr>
                                                        <tr>
                                                            <td><input type="text" class="form-control"
                                                            ...
                                                            <td><input type="text" class="form-control"
                                                                    ...
                                                                    id="nominal3" value="{{ old('nominal3') }}"></td>
                                                        </tr>
                                                        <tr>
                                                            <td><input type="text" class="form-control"
                                                            ...
                                                            <td><input type="text" class="form-control"
                                                                    ...
                                                                    id="nominal4" value="{{ old('nominal4') }}"></td>
                                                        </tr>
                                                        <tr>
                                                            <td><input type="text" class="form-control"
                                                            ...
                                                            <td><input type="text" class="form-control"
                                                                    ...
                                                                    id="nominal5" value="{{ old('nominal5') }}"></td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" class="form-control"
                                                                    ...
                                                                    id="pengeluaran5" value="{{ old('pengeluaran5') }}">
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
