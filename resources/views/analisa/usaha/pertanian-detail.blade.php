            ...
            <div class="container-xl">
              <div class="row g-2 align-items-center">
                ...
                <div class="col-auto ms-auto d-print-none">
                  <div class="btn-list">
                    <a href="{{ route('analisa.usaha.pertanian') }}" class="btn btn-primary">
                ...
                <div class="col d-flex flex-column">
                  <div class="card-body">
                    ...
                    <table class="table table-bordered table-vcenter fs-5">
                      ...
                      <thead>
                        <tr>
                          ...
                          <th class="text-center" colspan="1" rowspan="2">Sektor Ekonomi</th>
                        </tr>
                        <tr>
                      ...
                      <tbody>
                        <tr>
                          <td width="25%"><input class="form-control" type="text" name="" id=""
                      ...
                      <thead>
                        <tr>
                          ...
                          <td><input class="form-control text-center fw-bold" type="text" name="" id="" value="0M2"
                              disabled=""></td>
                        </tr>
                      </thead>
                    </table>
                    ...
                    <table class="table table-bordered table-vcenter fs-5">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><input class="form-control" type="text" name="" id="" placeholder="Masukan Angka"></td>
                    ...
                    <table class="table table-bordered table-vcenter fs-5">
                      ...
                      <tbody>
                        <tr>
                          <td>
                            <select class="form-control" name="" id="">
                              <option value="" class="text-center">--Pilih Jumlah Musim--</option>
                            </select>
                          </td>
                          <td><input type="text" class="form-control" placeholder="Masukan Nominal"></td>
                        </tr>
                      ...
                      <tbody>
                        <tr>
                          <td><input type="text" class="form-control" placeholder="Masukan Angka"></td>
                          <td><input type="text" class="form-control" placeholder="Masukan Nominal"></td>
                        </tr>
                      </tbody>
                    </table>
                    ...
                    <table class="table table-bordered table-vcenter fs-5">
                      ...
                      <thead>
                        <tr>
                          <th><input class="form-control" disabled="" value="Pendapatan Hasil Panen"></th>
                          <td><input type="text" class="form-control" readonly="" value="Rp. "></td>
                        </tr>
                        <tr>
                          <th><input class="form-control" disabled="" value="Pengeluaran Biaya Usaha"></th>
                          <td><input type="text" class="form-control" readonly="" value="Rp. "></td>
                        </tr>
                        <tr>
                          <th><input class="form-control" disabled="" value="Penambahan Hasil Usaha"></th>
                          <td><input type="text" class="form-control" readonly="" value="Rp. "></td>
                        </tr>
                        <tr>
                          <th><input class="form-control" disabled="" value="Pinjaman Bank Lain"></th>
                          <td><input type="text" class="form-control" readonly="" value="Rp. "></td>
                        </tr>
                        <tr>
