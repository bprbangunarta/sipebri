                                    ...
                                    @forelse ($data as $item)
                                        <tr>
                                            ...
                                            <td class="text-center"  style="vertical-align: middle;">
                                                ...
                                                data-pengajuan="{{ $item->kode_pengajuan }}" class="btn-circle btn-sm bg-green" title="Persetujuan">
                                                    <i class="fa fa-check-circle"></i>
                                                </a>

                                                &nbsp;
                                                <a data-toggle="modal" data-target="#modal-catatan"
                                                data-pengajuan="{{ $item->kode_pengajuan }}" class="btn-circle btn-sm bg-yellow" title="Catatan">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('komite.simpan') }}" method="POST">
                    ...
                    <div class="modal-footer" style="margin-top: -10px;">
                        <button type="button" class="btn bg-yellow" style="width: 100%;" data-dismiss="modal">TUTUP</button>
                    </div>
                </form>
            </div>
        </div>
