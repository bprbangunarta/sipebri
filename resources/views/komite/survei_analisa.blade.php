                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align: middle;">
                                        ...
                                        <b>TANGGAL :</b> {{ \Carbon\Carbon::parse($item->created_at)->format('Y-m-d') }}
                                    </td>

                                    @if (is_null($item->alamat_ktp))
                                    <td class="text-center" style="vertical-align: middle;">-</td>
                                    @else
                                    <td class="text-uppercase" style="vertical-align: middle;">{{ $item->alamat_ktp }} <br>
                                    ...
                                    <td style="vertical-align: middle;">
                                        ...
                                        <b>PLAFON :</b> {{ 'Rp.' . ' ' . number_format($item->plafon, 0, ',', '.') }}
                                    </td>
                                    ...
                                    <td class="text-center" style="vertical-align: middle;">
                                        ...
                                        <span class="btn bg-green" style="width: 120px;hight:100%;">{{ $item->tracking }}</span>
                                        @else
                                        <span class="btn bg-yellow" style="width: 120px;hight:100%;">{{ $item->tracking }}</span>
                                        @endif -->
                                        <span class="btn bg-yellow" style="width: 120px;">{{ $item->tracking }}</span>

                                        <p style="margin-top:-5px;"></p>
                                        <a data-toggle="modal" data-target="#modal-catatan" data-pengajuan="{{ $item->kode_pengajuan }}">
