                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md">
                                                    ...
                                                    @else
                                                    <input class="form-control" type="text" name="kota" id="kota"
                                                        placeholder="Kota" value="{{ old('kota', $nasabah->kota) }}">
                                                    @endif
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md">
                                                    ...
                                                    <textarea class="form-control" name="alamat_ktp" id="alamat_ktp"
                                                        placeholder="Alamat Lengkap"
                                                        required>{{ old('alamat_ktp', $nasabah->alamat_ktp) }}</textarea>
                                                    @endif
                                                ...
                                                <div class="col-md">
                                                    ...
                                                    <textarea class="form-control" name="alamat_sekarang"
                                                        id="alamat_sekarang" placeholder="Alamat Lengkap"
                                                        required>{{ old('alamat_sekarang', $nasabah->alamat_sekarang) }}</textarea>
                                                    @endif
