...
=======
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md">
                                                    ...
                                                    @else
                                                    <input class="form-control" type="text" name="kota" id="kota"
                                                        placeholder="Kota" value="{{ $nasabah->kota }}">
                                                    @endif
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md">
                                                    ...
                                                    <textarea class="form-control" name="alamat_ktp" id="alamat_ktp"
                                                        ...
                                                        required>{{ $nasabah->alamat_ktp }}</textarea>
                                                    @endif
                                                ...
                                                <div class="col-md">
                                                    ...
                                                    <textarea class="form-control" name="alamat_sekarang"
                                                        id="alamat_sekarang" placeholder="Alamat Lengkap"
                                                        required></textarea>
                                                    @else
                                                    <textarea class="form-control" name="alamat_sekarang"
                                                        id="alamat_sekarang" placeholder="Alamat Lengkap"
                                                        required>{{ $nasabah->alamat_sekarang }}</textarea>
                                                    @endif
                                                            ...
                                                            <div id="collapse-1" class="accordion-collapse collapse"
                                                                ...
                                                                <div class="accordion-body pt-0">
                                                                    <img class="rounded-2 mb-2 img-preview-ktp"
                                                                        src="{{ asset('storage/image/photo/' . $nasabah->photo_ktp) }}"
                                                                        class="card-img-top">
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="row g-3">
                                                <div class="col-md">
                                                    ...
                                                    <input type="text" name="oldphoto" value="{{ $nasabah->photo }}"
                                                        hidden>
...
>>>>>>> 9020e3def067f02afa4a00524701f8619165ae44
                                        </div>
                                    </div>
                                                ...
                                                <div class="row g-3">
                                                    <div class="col-md">
                                                        ...
                                                        <input type="text" class="form-control" name="no_cif"
                                                            id="no_cif" placeholder="00123456"
