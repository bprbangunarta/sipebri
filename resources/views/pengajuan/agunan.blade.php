                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <select type="text" class="form-select" placeholder="Jenis Agunan" name="kode_jenis"
                                    id="select-jenis">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                ...
                                <select type="text" class="form-select" placeholder="Jenis Dokumen" name="kode_dokumen"
                                    id="select-dokumen">
