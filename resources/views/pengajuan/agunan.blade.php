...
@section('content')
                                                        ...
                                                        @foreach ($jaminan as $item)
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    @if ($item->otorisasi == 'A')
                                                                        <span class="badge bg-success-lt">Sudah
                                                                            Otorisasi</span>
                                                                    @else
                                                                        <span class="badge bg-danger-lt">Minta
                                                                            Otorisasi</span>
                                                                    @endif
                                                                </td>
                                                                ...
                                                                @can('agunan otorisasi')
                                                                    <td class="text-center">
                                                                        <a href="#" data-bs-toggle="modal"
                                                                            ...
                                                                            data-id="{{ $item->id }}" title="Validasi Data">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label class="form-label">Jenis Agunan</label>
                                <input type="text" name="input_user" id="input_user" hidden>
    ...
    <div class="modal modal-blur fade" id="modal-validasi" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Validasi Agunan</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                @foreach ($jaminan as $item)
                    <form action="{{ route('pengajuan.validasiagunan', ['pengajuan' => $item->id]) }}" method="POST">
                @endforeach
                @method('put')
                @csrf
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label class="form-label">Jenis Agunan</label>
                                <input type="text" name="input_user" id="vinput_user" hidden>
                                <input type="text" name="data" id="vdata" hidden>
                                <select type="text" class="form-select" placeholder="Jenis Agunan"
                                    name="jenis_agunan_kode" id="vjenis">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label class="form-label">Jenis Dokumen</label>
                                <select type="text" class="form-select" placeholder="Jenis Dokumen"
                                    name="jenis_dokumen_kode" id="vdokumen">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label class="form-label">No Dokumen</label>
                                <input type="text" class="form-control" name="no_dokumen" id="vno_dok"
                                    placeholder="No Dokumen">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label class="form-label">Atas Nama</label>
                                <input type="text" class="form-control" name="atas_nama" id="vnama"
                                    placeholder="Nama Lengkap">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label class="form-label">Lokasi</label>
                                <textarea class="form-control" name="lokasi" id="vlok" rows="3"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <div class="mb-3">
                                <label class="form-label">Catatan</label>
                                <textarea class="form-control" name="catatan" id="vcatatans" rows="3"></textarea>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    <a href="#" class="btn btn-link link-secondary" data-bs-dismiss="modal">Batal</a>
                    <button type="submit" class="btn btn-primary ms-auto">Validasi</button>
                </div>
                </form>
            </div>
        </div>
