                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="#" title="Reset Password" data-bs-toggle="modal"
                                                data-bs-target="#modal-password" data-user="{{ $data->code_user }}">
                                        ...
                                        <td class="text-center">
                                            <form action="{{ route('user.destroy', ['user' => $data->code_user]) }}"
                                                method="POST">
                                                @method('delete')
                                                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="mb-3">
                                ...
                                <input type="password" class="form-control" name="reset" id="reset" value="123456"
                                    readonly>
                            </div>
                        </div>
                    </div>
