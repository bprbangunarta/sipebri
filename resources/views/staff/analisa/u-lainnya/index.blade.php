        ...
        <div class="tab-pane active">
            <table class="table table-striped table-hover table-bordered table-condensed">
                ...
                <tbody>
                    @forelse ($lain as $item)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('lain.identitas', ['pengajuan' => $item->kd_pengajuan, 'kode_usaha' => $item->kd_usaha]) }}"
                                    class="btn btn-sm btn-warning" style="float: left" title="Input Analisa">
                                    <i class="fa fa-file-text-o"></i></a>

                                <form
                                    action="{{ route('lain.destroy', ['id' => $item->id, 'kode_id' => $item->kode_id, 'kode_usaha' => $item->kd_usaha]) }}"
                                    method="POST">
                                    @method('delete')
                                    @csrf
                                    @method('delete')
                    ...
                    @empty
                        <tr>
                            <td class="text-center" colspan="7">Tidak ada analisa usaha lainnya.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
    ...
    <div class="modal fade" id="modal-tambah">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('lain.simpanlain', ['pengajuan' => $data->kd_pengajuan]) }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <select type="text" class="form-control" name="jenis_usaha" id="select-usaha">
