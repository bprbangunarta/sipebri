                    ...
                    <div class="col-xs-9">
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                                <li class="{{ request()->is('theme/analisa/identitas/usaha/perdagangan') ? 'active' : '' }}">
                                    <a href="/theme/analisa/identitas/usaha/perdagangan/" class="{{ request()->is('theme/analisa/identitas/usaha/perdagangan') ? 'text-bold' : '' }}">
                                        IDENTITAS
                                    </a>
                                </li>

                                <li class="{{ request()->is('theme/analisa/barang/usaha/perdagangan') ? 'active' : '' }}">
                                    <a href="/theme/analisa/barang/usaha/perdagangan/" class="{{ request()->is('theme/analisa/barang/usaha/perdagangan') ? 'text-bold' : '' }}">
                                        BARANG DAGANG
                                    </a>
                                </li>

                                <li class="{{ request()->is('theme/analisa/keuangan/usaha/perdagangan') ? 'active' : '' }}">
                                    <a href="/theme/analisa/keuangan/usaha/perdagangan/" class="{{ request()->is('theme/analisa/keuangan/usaha/perdagangan') ? 'text-bold' : '' }}">
                                        ANALISA KEUANGAN
                                    </a>
                                </li>
