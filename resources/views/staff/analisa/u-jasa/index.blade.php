...
<div class="tab-content">
    <div class="tab-pane active">
        <table class="table table-striped table-hover table-bordered table-condensed">
            ...
            <tbody>
                <tr>
                    <td style="vertical-align: middle;text-transform:uppercase;">KARYAWAN TETAP</td>
                    ...
                    <td class="text-center">
                        <a href="/theme/analisa/keuangan/usaha/jasa/" class="btn btn-sm btn-warning" style="float: left" title="Input Analisa">
