                    ...
                    @forelse ($jasa as $item)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('usahajasa.keuangan', ['pengajuan' => $data->kd_pengajuan, 'kode_usaha' => $item->kd_usaha]) }}"
                                    class="btn btn-sm btn-warning" style="float: left" title="Input Analisa">
                                    <i class="fa fa-file-text-o"></i></a>

                                <form
                                    action="{{ route('usahajasa.destroy', ['id' => $item->id, 'kode_id' => $item->kode_id, 'kode_usaha' => $item->kd_usaha]) }}"
                                    method="POST">
                                    @method('delete')
                                    @csrf
                                    @method('delete')
    ...
    <div class="modal fade" id="modal-tambah">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('usahajasa.store', ['pengajuan' => $data->kd_pengajuan]) }}" method="POST">
                    @csrf
