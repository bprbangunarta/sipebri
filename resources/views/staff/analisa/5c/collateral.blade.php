...
@section('content')
    <div class="tab-content">
        <div class="tab-pane active">
            ...
            <form action="{{ route('analisa5c.simpancollateral', ['pengajuan' => $data->kd_pengajuan]) }}" method="POST">
                @csrf
                    ...
                    <div class="div-left">
                        <div style="width: 49.5%;float:left;">
                            ...
                            <select class="form-control input-sm form-border text-uppercase agunan_utama" name="agunan_utama"
                                ...
                                <option value="3" {{ old('agunan_utama') == 3 ? 'selected' : '' }}>Milik Sendiri
                                </option>
                                <option value="1" {{ old('agunan_utama') == 1 ? 'selected' : '' }}>Orang Lain/Milik
                        ...
                        <div style="width: 49.5%;float:right;">
                            ...
                            <select class="form-control input-sm form-border text-uppercase legalitas_agunan"
                                ...
                                <option value="1" {{ old('legalitas_agunan') == 1 ? 'selected' : '' }}>Orang Lain/Milik
                                    Sendiri dan Orang Lain (Wariasan)</option>
                            </select>
                        </div>
                        ...
                        <div style="margin-top:5px;width: 49.5%;float:left;">
                            ...
                            <select class="form-control input-sm form-border text-uppercase mudah_diuangkan"
                                ...
                                <option value="2" {{ old('mudah_diuangkan') == 2 ? 'selected' : '' }}>BPKB, SHM
                                </option>
                        ...
                        <div style="margin-top:5px;width: 49.5%;float:right;">
                            ...
                            <select class="form-control input-sm form-border text-uppercase kondisi_kendaraan"
                                ...
                                <option value="2" {{ old('kondisi_kendaraan') == 2 ? 'selected' : '' }}>Original, Tidak
                                    Lengkap</option>
                                <option value="1" {{ old('kondisi_kendaraan') == 1 ? 'selected' : '' }}>Tidak
                                    Original,
                        ...
                        <div style="margin-top:5px;width: 49.5%;float:right;">
                            ...
                            <select class="form-control input-sm form-border text-uppercase agunan_tambahan"
                                ...
                                <option value="1" {{ old('agunan_tambahan') == 1 ? 'selected' : '' }}>Orang Lain/Milik
                                    Sendiri dan Orang Lain (Wariasan)</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="div-right">
                        <div style="width: 49.5%;float:left;">
                            ...
                            <select class="form-control input-sm form-border text-uppercase legalitas_agunan_tambahan"
                                ...
                                <option value="3" {{ old('legalitas_agunan_tambahan') == 3 ? 'selected' : '' }}>Milik
                                    Sendiri</option>
                                <option value="1" {{ old('legalitas_agunan_tambahan') == 1 ? 'selected' : '' }}>Orang
                        ...
                        <div style="margin-top:5px;width: 49.5%;float:left;">
                            ...
                            <select class="form-control input-sm form-border text-uppercase lokasi_shm" name="lokasi_shm"
                                id="collateral8">
                                <option value="">--Pilih--</option>
                                <option value="3" {{ old('lokasi_shm') == 3 ? 'selected' : '' }}>Strategis dan atau
                                    Produktif</option>
                                <option value="2" {{ old('lokasi_shm') == 2 ? 'selected' : '' }}>Strategis dan
                                    Produktif (Atau Sebaliknya)</option>
                                <option value="1" {{ old('lokasi_shm') == 1 ? 'selected' : '' }}>Kurang Strategis dan
