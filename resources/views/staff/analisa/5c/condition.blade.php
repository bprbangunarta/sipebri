                    ...
                    <div class="div-left">
                        <div style="width: 49.5%;float:left;">
                            ...
                            <select class="form-control input-sm form-border text-uppercase" name="kondisi_alam"
                                ...
                                <option value="5" {{ old('kondisi_alam') == 5 ? 'selected' : '' }}>Resiko Sangat Rendah
                                </option>
                                <option value="4" {{ old('kondisi_alam') == 4 ? 'selected' : '' }}>Resiko Rendah
                                </option>
                                <option value="3" {{ old('kondisi_alam') == 3 ? 'selected' : '' }}>Resiko Sedang
                                </option>
                                <option value="2" {{ old('kondisi_alam') == 2 ? 'selected' : '' }}>Resiko Tinggi
                                </option>
                                <option value="1" {{ old('kondisi_alam') == 1 ? 'selected' : '' }}>Resiko Sangat Tinggi
                                </option>
                            </select>
                        </div>
                        ...
                        <div style="width: 49.5%;float:right;">
                            ...
                            <select class="form-control input-sm form-border text-uppercase" name="persaingan_usaha"
                                ...
                                <option value="">--Pilih--</option>
                                <option value="3" {{ old('persaingan_usaha') == 3 ? 'selected' : '' }}>Persaingan Usaha
                                    Tidak Ketat</option>
                                <option value="2" {{ old('persaingan_usaha') == 2 ? 'selected' : '' }}>Persaingan Usaha
                                    Kurang Ketat</option>
                                <option value="1" {{ old('persaingan_usaha') == 1 ? 'selected' : '' }}>Persaingan Usaha
                                    Ketat</option>
                            </select>
                        </div>
                    </div>
