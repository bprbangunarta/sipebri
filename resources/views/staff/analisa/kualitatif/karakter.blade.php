                    ...
                    {{-- <div class="div-left">
                        ...
                        <div style="margin-top:5px;width: 49.5%;float:left;">
                            ...
                            <select class="form-control input-sm form-border text-uppercase" name="kewajiban2"
                                id="">
                                <option value="">--Pilih--</option>
                                <option value="Bank Umum" {{ old('kewajiban2') == 'Bank Umum' ? 'selected' : '' }}>Bank
                                    Umum
                                </option>
                                <option value="BPR" {{ old('kewajiban2') == 'BPR' ? 'selected' : '' }}>BPR</option>
                                <option value="Koperasi" {{ old('kewajiban2') == 'Koperasi' ? 'selected' : '' }}>
                                    Koperasi
                                </option>
                                <option value="Leasing" {{ old('kewajiban2') == 'Leasing' ? 'selected' : '' }}>Leasing
                                </option>
                                <option value="lainnya" {{ old('kewajiban2') == 'lainnya' ? 'selected' : '' }}>lainnya
                                </option>
                            </select>
                        </div>
                    ...
                    <div class="div-left" style="display: flex; justify-content: space-between; width:100%;">
                        <div style="margin-top:5px;width: 33%;">
                            ...
                            <select class="form-control input-sm form-border text-uppercase" name="kewajiban1"
                                id="">
                                <option value="">--Pilih--</option>
                                <option value="Bank Umum" {{ old('kewajiban1') == 'Bank Umum' ? 'selected' : '' }}>Bank
                                    Umum
                                </option>
                                <option value="BPR" {{ old('kewajiban1') == 'BPR' ? 'selected' : '' }}>BPR</option>
                                <option value="Koperasi" {{ old('kewajiban1') == 'Koperasi' ? 'selected' : '' }}>Koperasi
                        ...
                        <div style="margin-top:5px;width: 33%;">
                            ...
                            <select class="form-control input-sm form-border text-uppercase" name="status1" id=""
                                ...
                                <option value="Diragukan" {{ old('status1') == 2 ? 'selected' : '' }}>Diragukan</option>
                                <option value="Macet" {{ old('status1') == 1 ? 'selected' : '' }}>Macet</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="div-left" style="display: flex; justify-content: space-between; width:100%;">
                        ...
                        <div style="margin-top:5px;width: 33%;">
                            ...
                            <select class="form-control input-sm form-border text-uppercase" name="status2"
                                ...
                                <option value="Diragukan" {{ old('status2') == 2 ? 'selected' : '' }}>Diragukan</option>
                                <option value="Macet" {{ old('status2') == 1 ? 'selected' : '' }}>Macet</option>
                            </select>
                        </div>
                    ...
                    <div class="div-left" style="display: flex; justify-content: space-between; width:100%;">
                        ...
                        <div style="margin-top:5px;width: 33%;">
                            ...
                            <select class="form-control input-sm form-border text-uppercase" name="status3"
                                ...
                                <option value="Diragukan" {{ old('status3') == 2 ? 'selected' : '' }}>Diragukan</option>
                                <option value="Macet" {{ old('status3') == 1 ? 'selected' : '' }}>Macet</option>
                            </select>
                        </div>
