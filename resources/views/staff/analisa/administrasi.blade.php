                                    ...
                                    <div class="box-body" style="margin-top: -10px;font-size:12px;">
                                        ...
                                        <div class="div-left">
                                            <div style="width: 49.5%;float:left;">
                                                ...
                                                <input type="text" class="form-control input-sm form-border text-uppercase"" name="keuangan_kode" placeholder="Rp." readonly>
                                            </div>
                                            ...
                                            <div style="margin-top:5px;width: 49.5%;float:left;">
                                                ...
                                                <input type="text" class="form-control input-sm form-border text-uppercase"" name="keuangan_kode" placeholder="Rp.">
                                            </div>
