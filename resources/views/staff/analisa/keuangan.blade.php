                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active">
                                ...
                                <form action="{{ route('keuangan.simpan', ['pengajuan' => $data->kd_pengajuan]) }}"
                                    method="post">
                                    @csrf
                                    <div class="box-body" style="margin-top: -10px;font-size:12px;">
                                        ...
                                        <div class="div-right">
                                            ...
                                            <div style="margin-top:5px;width: 49.5%;float:left;">
                                                ...
                                                <input class="form-control input-sm form-border" type="text"
                                                    value="Rp." name="b_rumah_tangga" id="biaya" readonly>
                                            </div>
                                            <div style="margin-top:5px;width: 49.5%;float:right;">
                                                <span class="fw-bold">KEWAJIBAN LAINNYA</span>
                                                <input class="form-control input-sm form-border" type="text"
                                                    value="Rp." name="b_kewajiban_lainya" id="kewajiban_lain"
                                                    readonly>
                                            </div>
                                            ...
                                            <div style="margin-top:5px;width: 100%;float:left;">
                                                ...
                                                <input class="form-control input-sm form-border bg-blue" type="text"
                                                    value="Rp." name="keuangan_perbulan" id="hasilbersih" readonly>
                                            </div>
                                        </div>
