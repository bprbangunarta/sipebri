              ...
              <div class="row g-0">
                ...
                <div class="col d-flex flex-column">
                    ...
                    <div class="card-body">
                      ...
                      <div class="row g-3">
                        <div class="col-md">
                          ...
                          <select type="text" class="form-select" placeholder="Pilih Identitas" name="identitas"
                            id="select-identitas">
                        ...
                        <div class="col-md">
                          ...
                          <input type="text" value="{{ $nasabah->auth }}" name="input_user" hidden>
                          <input type="text" class="form-control" name="no_identitas" id="no_identitas"
                            placeholder="3213XXXXX" value="{{ old('no_identitas', $pendamping[0]->no_identitas) }}">
                        </div>
                        <div class="col-md">
                          <div class="form-label">Masa Identitas</div>
                          @if (is_null($pendamping[0]->masa_identitas))
                          <input class="form-control mb-2" placeholder="Pilih Tanggal" name="masa_identitas"
                            id="datepicker-masa-identitas" />
                          @else
                          <input class="form-control mb-2" placeholder="Pilih Tanggal" name="masa_identitas"
                            id="datepicker-masa-identitas-old" value="{{ $pendamping[0]->masa_identitas }}">
                          @endif
                        </div>
                      </div>
                      <p></p>
                      <div class="row g-3">
                        <div class="col-md">
                          ...
                          <input type="text" class="form-control" name="nama_pendamping" id="nama_pendamping"
                            placeholder="Nama Lengkap" value="{{ old('nama_pendamping') }}">
                          @else
                          <input type="text" class="form-control" name="nama_pendamping" id="nama_pendamping"
                        ...
                        <div class="col-md">
                          ...
                          @else
                          <input type="text" class="form-control" name="tempat_lahir" id="tempat_lahir"
                            placeholder="Tempat Lahir" value="{{ old('tempat_lahir', $pendamping[0]->tempat_lahir) }}">
                          @endif
                        ...
                        <div class="col-md">
                          ...
                          <input class="form-control mb-2" placeholder="Pilih Tanggal" name="tanggal_lahir"
                            id="datepicker-tanggal-lahir" />
                          @else
                          <input class="form-control mb-2" placeholder="Pilih Tanggal" name="tanggal_lahir"
                            id="datepicker-tanggal-lahir-old" value="{{ $pendamping[0]->tanggal_lahir }}">
                          @endif
                        </div>
                      </div>
                      <p></p>
                      <div class="row g-3">
                        <div class="col-md">
                          ...
                          <select type="text" class="form-select" placeholder="Pilih Status" name="status"
                            id="select-status">
                        ...
                        <div class="col-md">
                          ...
                          <select type="text" class="form-select" placeholder="Tanggungan" name="tanggungan"
                        ...
                        <div class="col-md">
                          ...
                          <select type="text" class="form-select" placeholder="Pisah Harta" name="pisah_harta"
                      ...
                      <div class="row g-3">
                        <div class="col-md">
                          ...
                          <input type="text" name="oldphoto" value="{{ $pendamping[0]->photo }}" hidden>

                          <input type="file" class="form-control" class="photo" name="photo" id="photo"
                            onchange="previewPhoto()">

                          <div class="accordion mt-2" id="accordion-ktp">
                            <div class="accordion-item">
                              <h2 class="accordion-header" id="heading-1" style="height: 50px;margin-top:-10px;">
                        ...
                        <div class="col-md">
                          ...
                          <input type="text" name="oldphotoktp" value="{{ $pendamping[0]->photo_ktp }}" hidden>

                          <input type="file" class="form-control" class="photo_ktp" name="photo_ktp" id="photo_ktp"
                            onchange="previewPhotoKtp()">
                          ...
                          <div class="accordion mt-2" id="accordion-ktp">
                            <div class="accordion-item">
                              ...
                              <div id="collapse-1" class="accordion-collapse collapse" data-bs-parent="#accordion-ktp">
                                <div class="accordion-body pt-0">
                  ...
                  <form action="#">
                    <div class="card-footer bg-transparent mt-auto">
                      <div class="btn-list justify-content-end">
                        <input type="text" name="otorisasi" id="otorisasi" value="A" hidden>
                        <button type="submit" class="btn btn-primary text-white ms-auto">
                          Otorisasi
                        </button>
                      </div>
